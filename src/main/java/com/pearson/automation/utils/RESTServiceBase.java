...
public class RESTServiceBase {
	...
	public Response getCallWithHeaderParam(Map<String, String> headers, String URL) throws Exception {
		return (Response) RestAssured.given().when().log().all().relaxedHTTPSValidation().headers(headers).log().all()
				.contentType(this.getContentType()).log().all().request().when().log().all().get(URL);
