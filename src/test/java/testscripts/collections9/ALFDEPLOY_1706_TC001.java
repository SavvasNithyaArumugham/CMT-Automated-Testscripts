...
public class ALFDEPLOY_1706_TC001 extends TestCase {
	...
	else
	{
		...
		sitesPage.siteFinder("jobqueueuichecksite15");			
			...
			sitesPage.enterIntoDocumentLibrary();
				...
				collectionPg.isDataImportStatusDisplayed(csvFileName[0],userName,reqSiteName,jobType[0],serverName,progress[0]);
