...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runTC043P1()
	{
		testParameters.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by sitemanager by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part1: Login with user and Create Site and invite user to site");
