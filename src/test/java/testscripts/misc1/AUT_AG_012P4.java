...
public class AUT_AG_012P4 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verfiy members of the site is able to 'Add Relationship' for between sites - Invite user with consumer role and Add Relationship");
