...
public class AUT_AG_098P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify that related activities displayed in the 'My Activity' dashlet, when a user leaves the site - Part 2");
