 ...
 * @author Cognizant
 */
public class AUT_AG_040P4 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void runTC040P4() {
		testParameters
				.setCurrentTestDescription("Verify if sitemanager is able to become owner of the file created by coordinator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part4: Login with user and check edit/delete folder");
