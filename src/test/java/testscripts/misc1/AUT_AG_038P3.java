 ...
 * @author Cognizant
 */
public class AUT_AG_038P3 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC038P3()
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to become owner of the file created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part3:Check the 'Become Owner' functionality");
