...
public class AUT_AG_077 extends TestCase
{
	...
	@Test
	public void MISC1_067()
	{
		testParameters.setCurrentTestDescription("Verify that User is able to perform Edit Online operation "
				+ "on a word document from doument actions in Shared Files.");
