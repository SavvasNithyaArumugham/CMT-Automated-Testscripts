...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runTC038P1()
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to become owner of the file created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part1: Login with user and Create Site and invite user to site");
