...
public class AUT_AG_043P3 extends TestCase {
	...
	@Test
	public void runTC043P3() {
		testParameters
				.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by sitemanager by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part4: Login with user and check edit/delete folder");
