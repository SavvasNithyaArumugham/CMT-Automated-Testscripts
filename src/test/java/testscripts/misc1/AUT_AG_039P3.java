...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to become owner of the file created by contributor by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part3:Check the 'Become Owner' functionality");
