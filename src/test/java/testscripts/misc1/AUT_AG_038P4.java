 ...
 * @author Cognizant
 */
public class AUT_AG_038P4 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void runTC038P4() {
		testParameters
				.setCurrentTestDescription("Verify if sitemanager is able to become owner of the file created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part4: Login with user and check edit/delete folder");
	...
	public void executeTest() {
		...
		boolean isDisplayedActionNameAction = sitesPage
				.checkActionNameForFolderOrFileInDocLibPage(
						actionNameForFileOrFolder, fileName);
		...
		if (isDisplayedActionNameAction) {
			...
			AlfrescoDocumentDetailsPageTest docDetailsPageTestObj = new AlfrescoDocumentDetailsPageTest(
					scriptHelper);
			docDetailsPageTestObj
					.verifyPropertiesInDocDetailPage(propertyValues);
		...
		if (sitePageTest
				.checkSelectedItemsDropdownOption(selectedItemMenuOptVal)) {
			docLibPg.selectDocumentLibItems("None");
