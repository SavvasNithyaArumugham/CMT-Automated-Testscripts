...
public class AUT_AG_012P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verfiy members of the site is able to 'Add Relationship' for between sites - Accept Site as Collaborator and Add Relationship");
