...
public class AUT_AG_041P4 extends TestCase {
	...
	@Test
	public void runTC041P4() {
		testParameters
				.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part4: Login with user and check edit/delete folder");
