...
public class AUT_AG_047 extends TestCase
{
	...
	public void MISC1_038()
	{
		testParameters.setCurrentTestDescription("1. Verify user is able to see 'cancel editing' option under selected items menu dropdown when selected multiple assets that are already locked for editing"
				+ "<br>2. Verify user is able to see 'cancel editing' option under selected items menu dropdown in my files section, when selected multiple assets that are already locked for editing"
				+ "<br>3. Verify user is able to see 'cancel editing' option under selected items menu dropdown in shared files section, when selected multiple assets that are already locked for editing");
