...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runTC034P1()
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to become owner of the folder created by coordinator by clicking 'Become Owner' in View details to have full ownership rights of the folder<br> - Part1: Login with user and Create Site and invite user to site");
