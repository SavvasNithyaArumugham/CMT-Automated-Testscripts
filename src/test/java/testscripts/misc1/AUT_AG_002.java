...
public class AUT_AG_002 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify user is able to add relationship between files where both the files having special characters in its name. Characters - ~!@#$%^&.=+,");
