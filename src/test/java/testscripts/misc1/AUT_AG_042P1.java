 ...
 * @author Cognizant
 */
public class AUT_AG_042P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC042P1()
	{
		testParameters.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by contributor by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part1: Login with user and Create Site and invite user to site");
