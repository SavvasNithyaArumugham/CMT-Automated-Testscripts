...
public class AUT_AG_003 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify user is able to add relationship to a file which has portuguese characters in its name. Characters - ãáàâçéêíõóôúü");
