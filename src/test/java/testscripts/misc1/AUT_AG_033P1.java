...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runTC033P1()
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to become owner of the folder created by contributor by clicking 'Become owner' in View details to have full ownership rights of the folder<br> - Part1: Login with user and Create Site and invite user to site");
