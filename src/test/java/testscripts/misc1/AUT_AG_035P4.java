...
public class AUT_AG_035P4 extends TestCase {
	...
	public void MISC1_032() {
		testParameters
				.setCurrentTestDescription("Verify if coordinator is able to become owner of the folder created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the folder<br> - Part4: Login with user and check edit/delete folder");
