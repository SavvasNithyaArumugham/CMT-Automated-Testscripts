...
public class AUT_AG_066 extends TestCase {
	...
	@Test
	public void MISC1_056() {
		testParameters
				.setCurrentTestDescription("Verify the calculate size option from selected items menu should not get displayed if we select files in document library page");
	...
	public void executeTest() {
		...
		docLibPg.selectDocumentLibItems("Documents");
