...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runTC041P3()
	{
		testParameters.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by collaborator by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part3:Check the 'Become Owner' functionality");
