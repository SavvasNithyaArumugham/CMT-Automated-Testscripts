 ...
 * @author Cognizant
 */
public class AUT_AG_028P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify if contributor is able to become owner of file or folder created by another user<br> - Part2:Check the presence of 'Become owner' option");
	...
	public void executeTest()
	{
		...
		for(String folderName:folderNamesList)
		{
			...
			docDetailsPageTest.verifyDocActionForNegativeCase(docActionName);
