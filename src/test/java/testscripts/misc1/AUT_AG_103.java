...
public class AUT_AG_103 extends TestCase
{
	...
	@Test
	public void MISC1_093()
	{
		testParameters.setCurrentTestDescription("Verify that user can retrive all failed jobs");
	...
	public void executeTest()
	{
		...
		homePageObj.getBulkFailedfromDashlet();
		
		AlfrescoHomePageTest appHomePgTest = new AlfrescoHomePageTest(scriptHelper);
		appHomePgTest.verifyBulkFailedJobsFromDashlet();
