...
public class AUT_AG_004 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify user is able to add relationship to a file which has latin characters in its name. Characters - ǼǽǾǖǿŦŢŤŒœŊŁĳĦĢĐĒðþ×Þ");
