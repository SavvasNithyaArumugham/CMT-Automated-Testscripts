...
public class AUT_AG_072 extends TestCase {
	...
	@Test
	public void MISC1_062() {
		testParameters
				.setCurrentTestDescription("Verify the folder size gets calculated individually for each folders for all selected folders if we select multiple folders from search result page and click on 'Calculate total size' from selected items menu");
