...
public class AUT_AG_020P2 extends TestCase
{
	...
	@Test
	public void MISC1_020()
	{
		testParameters.setCurrentTestDescription("Verify that user is not allowed to upload new version of a file, "
	...
	public void executeTest()
	{
		...
		siteTestObj.verifyFileUploadOFLockedFile(file);
	}
