...
public class AUT_AG_034P4 extends TestCase {
	...
	@Test
	public void runTC034P4() {
		testParameters
				.setCurrentTestDescription("Verify if sitemanager is able to become owner of the folder created by coordinator by clicking 'Become Owner' in View details to have full ownership rights of the folder<br> - Part4: Login with user and check edit/delete folder");
	...
	public void executeTest() {
		...
		for (String folderName : folderNamesList) {
			...
			if (sitePageTest
				...
				myFilesTestObj.verifyFolderDeletion(folderName);
