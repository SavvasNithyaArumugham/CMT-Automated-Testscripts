 ...
 * @author Cognizant
 */
public class AUT_AG_042P4 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC042P4()
	{
		testParameters.setCurrentTestDescription("Verify if coordinator is able to become owner of the file created by contributor by clicking 'Become Owner' in View details to have full ownership rights of the file<br> - Part4: Login with user and check edit/delete folder");
		...
		if (isDisplayedActionNameAction) {
			report.updateTestLog("Verify the '" + actionNameForFileOrFolder
					...
					"User able to view the '" + actionNameForFileOrFolder
							+ "' Option for any files/folder:<b>" + fileName,
					Status.FAIL);
