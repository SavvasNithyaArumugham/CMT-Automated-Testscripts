...
public class AUT_AG_061 extends TestCase {
	...
	@Test
	public void MISC1_051() {
		testParameters
				.setCurrentTestDescription("Verify the user who belongs to 'Folder calculation group' alone is getting 'Calculate Size' field in selected items menu if we select folders alone in document library page");
