 ...
 * @author Cognizant
 */
public class AUT_AG_065 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void MISC1_055() {
		testParameters
				.setCurrentTestDescription("Verify the folder size gets displayed in th popup by selecting multiple folders under document library page and click on calculate size from selected items menu");
