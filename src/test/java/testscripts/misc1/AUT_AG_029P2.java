...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify if consumer is able to become owner of file or folder created by another user<br> - Part2:Check the presence of 'Become owner' option");
