...
public class AUT_AG_067 extends TestCase {
	...
	@Test
	public void MISC1_057() {
		testParameters
				.setCurrentTestDescription("Verify the calculate size option from selected items menu should get displayed if we select both files and folders in document library page");
