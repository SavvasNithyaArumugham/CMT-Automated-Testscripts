 ...
 * @author Cognizant
 */
public class AUT_AG_032P4 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void runTC032P4() {
		testParameters
				.setCurrentTestDescription("Verify if sitemanager is able to become owner of the folder created by collaborator by clicking 'Become owner' in View details to have full ownership rights of the folder<br> - Part4: Login with user and check edit/delete folder");
