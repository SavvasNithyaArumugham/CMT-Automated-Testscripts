...
public class LSALF_2192_P1 extends TestCase {
	...
	public void executeTest() {
		...
		UIHelper.waitFor(driver);
		UIHelper.waitFor(driver);
		UIHelper.sendKeysToAnElementByXpath(driver, ExternalIDPrefixandSeparatorXpath, "Test123");
		UIHelper.waitFor(driver);
