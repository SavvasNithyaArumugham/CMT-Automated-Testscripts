 ...
 * @author Cognizant
 */
public class AUT_AG_25 extends TestCase {
	...
	public void executeTest() {
		...
		try {
			...
			if (UIHelper.checkForAnElementbyXpath(driver, pcsTest.pcslogo)
				...
				report.updateTestLog(
						"Verify  UI of standard search panel in 'Database Search - PCS' dash-let of the archive site",
		...
		try {
			...
			String ISBNValue = pcsObj.labelvaluereturned("ISBN-10",
					"txtIsbn10-pcs");

			if (ISBNValue.equals("0133405877")) {

				report.updateTestLog(
						"Verify the search results based on the input data are displayed",
