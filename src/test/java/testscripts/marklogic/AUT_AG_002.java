...
public class AUT_AG_002 extends TestCase {
	...
	@Test
	public void MARKLOGIC_002() {
		testParameters.setCurrentTestDescription("Verify if 'Add ResourceContainer Aspect' is visible under folder actions for the user who is member of 'Resource Container Manager' group and able to add the aspect to folder containing files <br>"+
	"ALFDEPLOY-3517_Verify the search results for work URN(created via Alfresco share) present in My files or Shared files or document library containing colon escaped with backslash via basic search <br>"+
				"ALFDEPLOY-3517_Verify the search results for work URN(created via Alfresco share) present in My files or Shared files or document library containing colon escaped with backslash via advanced search");
	...
	public void executeTest() {
		...
		String URL = adminPg.getValueInNodeBrowserDetailsPg("workURN");
	...
	//	System.out.println(adminPg.getValueInNodeBrowserDetailsPg("workURN"));
		...
		searchObj.commonMethodForPerformSimpleSearch(URL);
		...
		searchObj.inputAspectAdvSearchparam(Aspect,AspectProp,URL);
