...
public class AUT_AG_010 extends TestCase {
	...
	@Test
	public void MARKLOGIC_010() {
		testParameters.setCurrentTestDescription("Verify if cp:resourceContainer Aspect is applied when moving a folder from normal folder to RC folder");
