...
public class AUT_AG_172 extends TestCase {
	...
	@Test
	public void runAUT_AG_172() {
		testParameters
				.setCurrentTestDescription("Verify the user who is member of 'Metadata Synchronization Controller' group is able to view the 'Remove from Watched content items' on Assets folders where watched content is already added to that folder");
