...
public class AUT_AG_121 extends TestCase {
	...
	public void runAUT_AG_AUT_AG_APIWorkflowForFolder() {
		testParameters.setCurrentTestDescription("Validate the JSON response for work and manifestation URN generated when user uploads a document in watched content folder");
	...
	/*		
		...
		//	System.out.println(baseUrl);
			...
			*/
			marklogic.verifyallresponseValue(manifestationResp);
