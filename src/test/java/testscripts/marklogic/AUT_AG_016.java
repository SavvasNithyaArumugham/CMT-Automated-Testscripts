...
public class AUT_AG_016 extends TestCase {
	...
	@Test
	public void MARKLOGIC_016() {
		testParameters.setCurrentTestDescription("Verify if aspect and property are retained when copying a file and folder from normal folder to RC folder");
