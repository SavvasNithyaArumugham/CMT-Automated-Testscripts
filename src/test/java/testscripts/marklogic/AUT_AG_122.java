...
public class AUT_AG_122 extends TestCase {
	...
	public void runAUT_AG_AUT_AG_APIWorkflowForFolder() {
		testParameters.setCurrentTestDescription("Validate the JSON response for work and manifestation URN generated when user moves a document into watched content folder from normal folder");
