...
public class AUT_AG_012 extends TestCase {
	...
	@Test
	public void MARKLOGIC_012() {
		testParameters.setCurrentTestDescription("Verify if aspect and property are retained when moving a file and folder from normal folder to RC folder");
