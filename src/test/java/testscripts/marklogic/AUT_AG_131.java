...
public class AUT_AG_131 extends TestCase {
	...
	@Test
	public void runAUT_AG_AUT_131() {
		testParameters.setCurrentTestDescription("Validate the JSON response for work and manifestation URN generated if user uploads a folder under watched content folder");
