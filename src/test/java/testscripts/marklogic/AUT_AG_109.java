...
public class AUT_AG_109 extends TestCase {
	...
	@Test
	public void runAUT_AG_109() {
		testParameters
				.setCurrentTestDescription("Verify the user who is member of 'Metadata Synchronization Controller' group is able to view either 'Add to watched content' or 'Remove from Watched content items' on folders at a time");
	...
	public void executeTest() {
		...
		if (sitesPage.checkMoreSettingsOption(folderName, moreSetOptions[0])) {
			report.updateTestLog("Verify '" + moreSetOptions[0]
					+ "' aspect for empty folder under 'More' option",
					moreSetOptions[0] + "is not displayed", Status.FAIL);
