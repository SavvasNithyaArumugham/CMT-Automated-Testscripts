...
public class AUT_AG_124 extends TestCase {
	...
	public void runAUT_AG_AUT_133() {
		testParameters.setCurrentTestDescription("Validate the JSON response for work and manifestation URN generated when user links a document from watched content folder to watched content folder");
	...
	public void executeTest() {
		...
		//	sitesPage.documentdetails(fileName);
			...
			sitesPage.commonMethodForClickOnMoreOptionLink(fileName,
					moreSetOptions[2]);
			docLibPage.performLinkToOperation(siteNameValue, folderName);
