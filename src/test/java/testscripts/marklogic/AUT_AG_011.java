...
public class AUT_AG_011 extends TestCase {
	...
	@Test
	public void MARKLOGIC_011() {
		testParameters.setCurrentTestDescription("Verify if aspect and property of source are retained when moving a file and folder from RC folder to RC folder");
