...
public class AUT_AG_113 extends TestCase {
	...
	@Test
	public void runAUT_AG_113() {
		testParameters
				.setCurrentTestDescription("Verify that user is able to see the generated URN in folder properties window after applying watched content aspect");
