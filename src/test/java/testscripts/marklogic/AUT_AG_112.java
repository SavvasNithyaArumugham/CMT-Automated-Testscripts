 ...
 */
public class AUT_AG_112 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_112()
	{
		testParameters.setCurrentTestDescription("Verify the user who is not a member of 'Metadata Synchronization Controller' group is not able to view the Add to or Remove from Watched content items");
	...
	public void executeTest()
	{
		...
		if (sitesPage.checkMoreSettingsOption(folderName, moreSetOptions[0])) {
			report.updateTestLog("Verify '" + moreSetOptions[0]
					...
					"Verified Successfully", Status.FAIL);

		} else {
			report.updateTestLog("Verify '" + moreSetOptions[0]
					+ "' aspect for empty folder under 'More' option",
					"Not able to Verify", Status.PASS);
		}
