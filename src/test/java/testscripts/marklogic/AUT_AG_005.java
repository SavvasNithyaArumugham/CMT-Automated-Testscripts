...
public class AUT_AG_005 extends TestCase {
	...
	@Test
	public void MARKLOGIC_005() {
		testParameters.setCurrentTestDescription("Verify if 'Add ResourceContainer Aspect' is not visible under More option/document actions of file for the user who is member of 'Resource Container Manager' group");
