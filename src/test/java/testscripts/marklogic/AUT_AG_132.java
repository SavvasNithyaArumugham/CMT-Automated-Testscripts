...
public class AUT_AG_132 extends TestCase {
	...
	@Test
	public void runAUT_AG_AUT_132() {
		testParameters.setCurrentTestDescription("Validate the JSON response for work and manifestation URN generated if user moves a folder from normal folder to watched content folder");
	...
	public void executeTest() {
		...
		sitesPage.commonMethodForClickOnMoreOptionLink(folderName2,
				moreSetOptions[2]);
		docLibPage.performMoveToOperation(siteNameValue, folderName1);
		...
		String urnUrl = myFiles.getMarkLogicManifestUrl(actualURNUrl2);
		String workURNUrl = myFiles.getMarkLogicManifestUrl(actualWorkURL2);
