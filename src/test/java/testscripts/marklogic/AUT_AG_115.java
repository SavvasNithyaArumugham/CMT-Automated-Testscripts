...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void runAUT_AG_115()
	{
		testParameters.setCurrentTestDescription("Verify if we add watched content aspect for folders,then the aspect will get inherited to all its sub files and folders");
