...
public class AUT_AG_111 extends TestCase {
	...
	@Test
	public void runAUT_AG_111() {
		testParameters
				.setCurrentTestDescription("Verify the user who is not a member of 'Metadata Synchronization Controller' group is not able to view the Add to or Remove from Watched content items");
