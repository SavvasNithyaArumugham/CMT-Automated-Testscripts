...
public class AUT_AG_025P2 extends TestCase {
	...
	@Test
	public void runAUT_AG_001P2() {
		testParameters
				.setCurrentTestDescription("1. Manager role should be able to create a proof via alfresco<br>"
						+ " 2. Share the Proof with Someone Else option NOT available. <br>"
						+ "Part2: Check received mail of ProofHQ and click on 'Goto ProofHQ' link in mail");
