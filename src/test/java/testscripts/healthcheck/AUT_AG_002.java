...
public class AUT_AG_002 extends TestCase {
	...
	@Test
	public void AVT_05() {
		testParameters.setCurrentTestDescription("14	Verify user is able to upload multiple files for caption field in Related files section <br>"
				+ "21	Verify the user is able to upload the .mp4 video file in alfresco using streaming media by uploading files for Related files tab fields and verify the JSON creation post- upload <br>"
				+ "22	Verify the user is able to upload the .m4v video file in alfresco using streaming media by uploading files for Related files tab fields and verify the JSON creation post upload <br>"
				+ "23	Verify the user is able to upload the .mov video file in alfresco using streaming media by uploading files for Related files tab fields and verify the JSON creation post upload <br>"
				+ "26	Verify the content of the streaming folder contains the appropriate Related files<br>" 
