...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("UNZIP <br>"+"Verify user can unzip a folder once uploaded into alfresco by selecting Extract to '/folder name' option");
	...
	public void executeTest()
	{
		...
		for(String folderName:folderNamesList)
		{
			...
			myFiles.openCreatedFolder(finalFileName);
			
			myFilesTestObj.verifyUploadedFile(fileName1, "");
