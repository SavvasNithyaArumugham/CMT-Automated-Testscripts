...
public class AUT_AG_002 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the searching options displayed when selecting a folder in 'Database Search - EPM' dash-let of the archive review site.");
	...
	public void executeTest()
	{
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.EPMSearchPanel(searchContent, property);
