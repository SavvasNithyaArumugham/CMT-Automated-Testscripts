...
public class AUT_AG_007 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the user is able to view all the results using [<] and [>] buttons in search results page of 'Database Search - EPM' dash-let.");
	...
	sitesPage.siteFinder(sourceSiteName);
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.clickOnEPMNextButton();
			siteDashboard.clickOnEPMPreviousButton();
