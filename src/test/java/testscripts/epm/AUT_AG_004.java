...
public class AUT_AG_004 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify all the values entered in the fields are cleared by clicking on [EMPTY] button in 'Database Search - EPM' dash-let of the archive review site.");
	...
	public void executeTest()
	{
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.clickOnEPMSearchEmpty();
			siteDashboard.validateEmptyButton();
