...
public class AUT_AG_010 extends TestCase {
	...
	public void runAUT_AG_010() {
		testParameters
				.setCurrentTestDescription("Verify the existing metadata of an archive folder overridden by the updated values when attaching the same record to the folder");
	...
	sitesPage.siteFinder(sourceSiteName);
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.clickOnProceedBtnInWarningMessagePopup(folderName);
		}
	}
