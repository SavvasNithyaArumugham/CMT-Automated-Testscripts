...
public class AUT_AG_005 extends TestCase {
	...
	public void runAUT_AG_005() {
		testParameters.setCurrentTestDescription(
				"Verify the user is able to return back to the archive folder list from search panel by clicking on [EXIT] button in 'Database Search - EPM' dash-let of the archive review site..");
	...
	//	homePageObj.navigateToSitesTab();
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.clickOnEPMSearchExit();
