...
public class AUT_AG_016 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the warning message window displayed when trying to search with incorrect data in the search fields.");
	...
	sitesPage.siteFinder(sourceSiteName);
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.enterToDate("14/04/2016");
