...
public class AUT_AG_013 extends TestCase {
	...
	public void runAUT_AG_013() {
		testParameters
				.setCurrentTestDescription("Verify the user is able to navigate between Find and search results tab when first search for an archive folder is done");
	...
	sitesPage.siteFinder(sourceSiteName);
		...
		for (String folderName : folderNamesList) {
			...
			siteDashboard.clickOnFindTabInDatabaseSearchEPM();
			
			siteDashboard.clickOnSearchResultsTabInDatabaseSearchEPM();
		}
	}
