...
public class AUT_AG_021 extends TestCase
{
	...
	@Test
	public void runAUT_AG_959()
	{
		testParameters.setCurrentTestDescription("Verify user is able to sort records based on Program Name,folder name and ISBN values in "
				+ "<br>Database Search - EPM dashlet after attaching EPM record");
	...
	sitesPage.siteFinder(sourceSiteName);
		...
		for (String folderName : folderNamesList) {
			...
			String searchContent="bana";
			String property="Author";
			siteDashboard.searchEPM(searchContent,property);
		
		}
		
		ArrayList<String> sortByList = new ArrayList<String>();
		sortByList.add("Folder Name");
		sortByList.add("Program Name");
		sortByList.add("ISBN");
		...
		{
			siteDashboardTest.verifySortedLibrary(sortBy);
		}
