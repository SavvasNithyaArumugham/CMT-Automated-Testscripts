...
public class AUT_AG_064Part1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the task completion notification email - 'Simple Task' Workflow (Multiple Assignees)<br> Part1: Create a Task");
