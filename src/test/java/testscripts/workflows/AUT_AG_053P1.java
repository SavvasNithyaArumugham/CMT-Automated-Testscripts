 ...
 * @author Cognizant
 */
public class AUT_AG_053P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify assignee name in the task assignment notification email - 'Simple Review and Approve' Workflow - Part1");
