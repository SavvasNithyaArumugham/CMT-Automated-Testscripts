...
public class AUT_AG_060Part1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the task re-assignment notification email - 'Simple Review and Approve' Workflow (Single Assignee) <br> Part1: Create and complete a Task");
