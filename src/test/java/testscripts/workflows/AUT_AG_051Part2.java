...
public class AUT_AG_051Part2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify date/time stamp in the task completion notification email - 'Simple Task' Workflow - Part 2");
