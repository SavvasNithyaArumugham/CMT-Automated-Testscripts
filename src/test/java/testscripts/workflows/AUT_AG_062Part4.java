...
public class AUT_AG_062Part4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the notification email, on task re-assignment of the rejected task(by Assignee2) - 'Simple Review and Approve' Workflow(Multiple Assignees) <br> Part3:Verify Comment details in Email");
