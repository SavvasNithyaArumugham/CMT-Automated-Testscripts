...
public class AUT_AG_068Part1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify the task is not completed, if any one of assignees approve the task- 'Simple Review and Approve' Workflow (Multiple Assignee/Reviewer) <br> Part1: Create and complete a Task");
