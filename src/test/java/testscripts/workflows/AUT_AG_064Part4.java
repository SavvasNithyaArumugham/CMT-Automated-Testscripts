...
public class AUT_AG_064Part4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the task completion notification email - 'Simple Task' Workflow (Multiple Assignees)<br> Part4:Verify Comment details in Email");
