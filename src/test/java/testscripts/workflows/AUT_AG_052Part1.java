...
public class AUT_AG_052Part1 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify date/time stamp in the task completion notification email - 'Simple Review and Approve Task' Workflow - Part 1");
