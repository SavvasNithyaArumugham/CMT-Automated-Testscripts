...
public class AUT_AG_090P6 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify the outcome value displayed in workflow task detail when reviewer approves/rejects the task<br> - Part 3: Login with reviewer2 and Verify that user is able to approve a task");
