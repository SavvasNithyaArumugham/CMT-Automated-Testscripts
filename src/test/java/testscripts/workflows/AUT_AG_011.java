...
public class AUT_AG_011 extends TestCase{
	...
	@Test
	public void workflows_09()
	{
		testParameters.setCurrentTestDescription("Check whether user is able to give greater than 1000 characters in workflow 'message' field");
	...
	public void executeTest() {
		...
		for (String folderName : folderNamesList) {
			...
			taskPageTest.verifyCreatedWorkflowForGivenMsgFieldCharactersInNegative(message+"_"+dueDate);
		}
	}
