...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Validate the reviewer user able to leave the site via mail - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
