...
public class AUT_AG_075P2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that task assigner is able to see when an edit has been accepted by an assignee<<br> - Part2: Verify that user is able to complete a task");
