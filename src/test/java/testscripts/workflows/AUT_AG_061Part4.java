...
public class AUT_AG_061Part4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the task completion notification email on rejection of the task - 'Simple Review and Approve' Workflow (Multiple Assignee) <br> Part4:Verify Comment details in Email");
