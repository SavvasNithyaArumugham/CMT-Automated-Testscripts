...
public class AUT_AG_065Part1 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To verify reviewer is not able to edit task - 'Simple Task' Workflow(Single Assignee\\Reviewer -  Part1");
