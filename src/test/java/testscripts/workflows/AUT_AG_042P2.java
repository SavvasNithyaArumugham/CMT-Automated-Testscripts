...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that Reviewer user is able start Simple review and approve type of workflow for files - Part2: Login has reviewer and check files are visible");
