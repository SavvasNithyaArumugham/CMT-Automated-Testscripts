...
public class AUT_AG_053P4 extends TestCase{
	...
	public void executeTest() {
		...
		String intAssignNme =  pearsonMailObj.openMailAndCheckAssigneeNmeForRevTaskCompl(inititatorName);
		...
		{
			report.updateTestLog("Verify Initiator name in the task Completion notification email",
					"Initiator Name wrongly displayed in the Mail received. Initiator Name displayed --> "+intAssignNme, Status.FAIL);
		}
