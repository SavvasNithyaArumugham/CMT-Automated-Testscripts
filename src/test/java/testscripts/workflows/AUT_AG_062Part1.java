...
public class AUT_AG_062Part1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("To verify comment detail in the notification email, on task re-assignment of the rejected task(by Assignee2) - 'Simple Review and Approve' Workflow(Multiple Assignees) <br> Part1: Create and complete a Task");
