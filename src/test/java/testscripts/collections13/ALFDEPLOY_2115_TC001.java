...
public class ALFDEPLOY_2115_TC001 extends TestCase {
	...
	public void COLLECTIONS_049() {
		testParameters
				.setCurrentTestDescription("Check Skills Teaching Opportunities: New property for Content Objects");
	...
	//  login
			...
			try {
				CSVUtil.updateCSV(downloadedCSVFileANmeWithPath, input1 ,2 ,100);
			} catch (IOException e) {
	...
	// Upload the updated CSV ( new value updated for Skills Teaching Opportunities field)
		...
		WebElement select1 = driver.findElement(By.xpath("//*[@id=\"template_x002e_edit-metadata_x002e_edit-metadata_x0023_default_prop_cpnals_theme-entry\"]/option[3]"));
		 ...
		 Actions action = new Actions(driver);
			...
			UIHelper.waitFor(driver);
			collectionPg.VerifyPropertyValueINviewDetails("Skills Teaching Opportunities:", "Core Unit Themes,Alternate Unit Themes");	
			UIHelper.waitFor(driver);
