...
public class AUT_AG_009 extends TestCase
{
	...
	@Test
	public void ADMIN_008()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to Edit the properties of group.");
	...
	public void executeTest()
	{
		...
		if(appAdminToolsPg.searchGpAndDelete(groupName)){
			...
			appAdminToolsPg.searchGpAndDelete(editgpName);			
		}
		appAdminToolsPg.editGroup();
		
		
		AlfrescoAdminToolsPageTest appAdminToolsPgTest = new AlfrescoAdminToolsPageTest (scriptHelper);
		appAdminToolsPgTest.VerifyEditGroup();
	}
