...
public class AUT_AG_028P2 extends TestCase
{
	...
	@Test
	public void ADMIN_026()
	{
		testParameters.setCurrentTestDescription("Verify that user who is added in user_Admin is able to create new user accounts from Admin tool page. - Create new user accounts ");
