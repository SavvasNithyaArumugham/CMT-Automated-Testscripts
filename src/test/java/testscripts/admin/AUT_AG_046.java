...
public class AUT_AG_046 extends TestCase {
	...
	@Test
	public void ADMIN_044() {
		testParameters
				.setCurrentTestDescription("Verify that non admin user (who is not a part of Group SITE_ADMIN and ALFRESCO_ADMINISTRATORS) is not able to see create site option in Sites tab from simple search result page.");
