...
public class AUT_AG_047 extends TestCase {
	...
	@Test
	public void ADMIN_045() {
		testParameters
				.setCurrentTestDescription("Verify that if user is ADMIN user (Part of group ALFRESCO_ADMINISTRATORS ) but not in SITE_ADMIN group should not able to see create site option from Advance search result page");
