...
public class AUT_AG_025P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user who is in Group_Admin will able to create new sub group to group - Create a sub group to group");
	...
	public void executeTest()
	{
		...
		if(appAdminToolsPg.searchGroupASGroupAdmin(groupName)){
		...
		appAdminToolsPg.browseGroupInUserAdmin(groupName);
		appAdminToolsPg.createSubGroupInUserAdmin();		
		AlfrescoAdminToolsPageTest appAdminToolsPgTest = new AlfrescoAdminToolsPageTest (scriptHelper);		
		appAdminToolsPgTest.VerifyCreateSubgroupUserAdmin();
	}
