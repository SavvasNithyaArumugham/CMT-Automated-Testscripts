...
public class AUT_AG_048 extends TestCase {
	...
	@Test
	public void ADMIN_046() {
		testParameters
				.setCurrentTestDescription("Verify that if user is ADMIN user (Part of group ALFRESCO_ADMINISTRATORS and SITE_ADMIN ) should be able to see create site option from Simple search result page");
