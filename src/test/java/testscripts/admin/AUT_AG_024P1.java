...
public class AUT_AG_024P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user who is in Group_Admin will not able to add user in group - Add a non admin user to Group_Admin");
