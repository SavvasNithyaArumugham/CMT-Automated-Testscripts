...
public class AUT_AG_026P2 extends TestCase
{
	...
	@Test
	public void ADMIN_024()
	{
		testParameters.setCurrentTestDescription("Verify that user who is added in Group_Admin is not able to create user- Create a user as GROUP-ADMIN");
	...
	public void executeTest()
	{
		...
		appAdminToolsPgTest.isUserMgmtAvailable();	
	}
