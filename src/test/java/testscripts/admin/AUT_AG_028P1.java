...
public class AUT_AG_028P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user who is added in user_Admin is able to create new user accounts from Admin tool page.- Add a non admin user to USER_Admin");
