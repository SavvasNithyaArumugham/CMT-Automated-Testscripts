...
public class AUT_AG_027P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user who is added in user_Admin Group is able to see only User Option on the Admin Tool Page- Add a non admin user to USER_Admin");
