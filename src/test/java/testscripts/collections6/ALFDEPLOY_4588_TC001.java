...
public class ALFDEPLOY_4588_TC001 extends TestCase {
	...
	public void executeTest() {
		...
		try {
			if(!CSVUtil.verifyDataInCell(downloadedCSVFileANmeWithPath,"",1,92))//Modified as part of NALS
				{
				report.updateTestLog(" Confirm that Column CO (State Code) shows blank values",
						"Column CO (State Code) does not show blank values", Status.PASS);//Modified as part of NALS
				}
			else
			{
				report.updateTestLog(" Confirm that Column CO (State Code) shows blank values",//Modified as part of NALS
