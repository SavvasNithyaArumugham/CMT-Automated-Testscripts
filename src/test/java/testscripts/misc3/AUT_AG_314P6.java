 ...
 * @author Cognizant
 */
public class AUT_AG_314P6 extends TestCase {
	...
	public void executeTest() {
		...
		if (docDetailsPage.getCurrentVersion().equals("1.1")) {
			report.updateTestLog("Verify the file is updated with next minor version",
					"file " + fileName + " is updated with next minor version " + docDetailsPage.getCurrentVersion(),
					Status.PASS);
		} else {
			report.updateTestLog("Verify the file is updated with next minor version",
					"file " + fileName + " is not updated with next minor version" + docDetailsPage.getCurrentVersion(),
					Status.FAIL);
		}
