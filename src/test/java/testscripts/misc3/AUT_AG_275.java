 ...
 * @author Cognizant
 */
public class AUT_AG_275 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_058()
	{
		testParameters.setCurrentTestDescription("Verify that user can perform 'All Aspect Templates','Bulk Download' and 'Metadata Template'  from Search result page.");
