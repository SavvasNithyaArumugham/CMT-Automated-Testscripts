 ...
 * @author Cognizant
 */
public class AUT_AG_315P4 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email after 1 hour, if the Notifications is set as 'Every  Hour' while Shared folder is updated with new file inside the subfolder"
