 ...
 * @author Cognizant
 */
public class AUT_AG_296P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Validate the user with reviewer role not able to delete the file/folder - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
