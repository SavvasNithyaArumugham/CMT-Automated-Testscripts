...
public class AUT_AG_280 extends TestCase{
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to see sites in Mysite dashlet when filtered with Recent'");
	...
	public void executeTest() {
		...
		homePageTest.verifyFilteredRecentSitesInMySitesDashlet();
