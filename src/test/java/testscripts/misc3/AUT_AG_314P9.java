 ...
 * @author Cognizant
 */
public class AUT_AG_314P9 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email immediately, if the Notifications is set as 'Immediately' while Shared folder is linked files with other sites,inside the subfolder"
