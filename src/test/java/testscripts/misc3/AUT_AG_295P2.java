 ...
 * @author Cognizant
 */
public class AUT_AG_295P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Validate the user able to see the metadata properties for any folder/file in the document library with the reviewer role - Part2: Login has reviewer and check files are visible");
