 ...
 * @author Moshin
 */
public class AUT_AG_213P1 extends TestCase {
	...
	public void misc3() {
		testParameters
				.setCurrentTestDescription("1.Verify that the Help Option is availabe under User Dropdown for Non-Admin users"
						...
						+"<br>2. Verify that the page is directing to Alfresco Training Site  Link  on clicking Help"
						+"<br>3. Verify that the page is directing to Alfresco Training Site  Link  on clicking Help");
