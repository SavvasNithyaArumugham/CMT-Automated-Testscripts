 ...
 * @author Cognizant
 */
public class AUT_AG_308P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the folder path is not displayed in aggregated activity email when the Shared root folder is updated for 8 hour interval notification frequency."
						+ "<br>Internal User upload folder,add file and shared externally, for verifying folder path not displaying in 8hr Aggregated mail");
	...
	public void executeTest() {
		...
		String properties = dataTable.getData("Sharebox", "ShareboxFieldsData")
				.replaceAll("Name:Craft",
						"Name:8hrRootFolderTest"+ "_" +date);
