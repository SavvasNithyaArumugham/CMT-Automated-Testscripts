 ...
 * @author Cognizant
 */
public class AUT_AG_314P3 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email immediately, if the Notifications is set as 'Immediately' while Shared folder is updated with new file,inside the subfolder"
