 ...
 * @author Cognizant
 */
public class AUT_AG_293P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Validate the user able to see all the files and folders in the document library with the reviewer role - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
