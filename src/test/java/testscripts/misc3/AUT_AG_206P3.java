 ...
 * @author Cognizant
 */
public class AUT_AG_206P3 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_001()
	{
		testParameters.setCurrentTestDescription("Verify that file should be remain followed when user Copy/Move/Link file to some location<br> - Part1: Verify that file should be remain followed when user Link file to some location");
