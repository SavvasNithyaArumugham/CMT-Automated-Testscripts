 ...
 * @author Cognizant
 */
public class AUT_AG_318P3 extends TestCase {

	@Test
	public void sharebox_008() {
		testParameters.setCurrentTestDescription(
				"Verify user can upload files using shared external mail via External Sharebox UI in DeepLevelFolder from Upload section.");
	...
	public void executeTest() {
		...
		String folderDetails[] = dataTable.getData("MyFiles", "CreateFileDetails").split(",");
		...
		for (String fldrName : folderDetails) {
			UIHelper.waitFor(driver);
			shareboxPg.navigateShareUI(fldrName);
			UIHelper.waitFor(driver);
		}
