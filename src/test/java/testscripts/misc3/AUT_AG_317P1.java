 ...
 * @author Cognizant
 */
public class AUT_AG_317P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the folder path is displayed in aggregated activity email when the Shared subfolder is available inside the unshared root folder is updated with new file by external user inside the subfolder for 1 hour interval notification frequency."
						+ "<br>Internal User upload folder,add child folder shared externally, for verifying folder path displaying in 1hr Aggregated mail");
	...
	public void executeTest() {
		...
		docLibPg.commonMethodForClickOnMoreSettingsOption(
				allFolderNamesList.get(2), moreSettingsOptionName);
