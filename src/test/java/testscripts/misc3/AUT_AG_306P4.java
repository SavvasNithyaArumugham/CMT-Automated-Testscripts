 ...
 * @author Cognizant
 */
public class AUT_AG_306P4 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Part2:Verify the user receives the notification email immediately, if the Notifications is set as 'immediately' while sharing the Folder"
