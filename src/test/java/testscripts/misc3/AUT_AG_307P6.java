 ...
 * @author Cognizant
 */
public class AUT_AG_307P6 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email after 1 hour, if the Notifications is set as 'Every Hour' while updating shared root folder"
