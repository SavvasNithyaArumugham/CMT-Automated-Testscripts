...
public class AUT_AG_210 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void misc3_004() {
		testParameters
				.setCurrentTestDescription("Verify user is able to follow an asset through link provided in asset detail/preview page");
	...
	public void executeTest() {
		...
		for(String folderName:folderNamesList)
		{
			...
			docDetailsPgTest.verifyFollowedDocInDocDetailsPg(folderName);
		...
		docDetailsPgTest.verifyFollowedDocInDocDetailsPg(fileName);
	}
