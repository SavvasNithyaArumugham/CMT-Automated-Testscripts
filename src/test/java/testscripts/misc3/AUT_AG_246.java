 ...
 * @author Cognizant
 */
public class AUT_AG_246 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void misc3_034() {
		testParameters
				.setCurrentTestDescription("TC044_7-14 point to an external URI and assign to a task_within site");
