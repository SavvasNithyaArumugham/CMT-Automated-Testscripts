...
public class AUT_AG_279 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_061()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to see sites in Mysite dashlet when filtered with Favorite");
	...
	public void executeTest() {
		...
		homePageTest.verifyFilteredFavoriteSitesInMySitesDashlet();
