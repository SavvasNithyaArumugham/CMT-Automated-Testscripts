...
public class AUT_AG_315P1 extends TestCase {
	...
	public void sharebox_003() {
		testParameters.setCurrentTestDescription("Verify the folder path is displayed in aggregated activity email when the Shared folder is updated with new file inside the subfolder for 1 hour interval notification frequency."
				+"<br>Internal shared externally root folder, for verifying folder path displaying in 1hr Aggregated mail");
