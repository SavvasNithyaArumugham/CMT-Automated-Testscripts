 ...
 * @author Cognizant
 */
public class AUT_AG_288P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Verify that user with Coordinator role have permissions to Renamecontent created by another user<br> - Part2:Accept invitation to join in Site and perform Rename operation");
