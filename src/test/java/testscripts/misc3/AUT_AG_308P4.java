 ...
 * @author Cognizant
 */
public class AUT_AG_308P4 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters.setCurrentTestDescription(
				"Internal User linked sub folder and files to other site folders and files, for verifying folder path not displaying in 8hr Aggregated mail");
