 ...
 * @author Cognizant
 */
public class AUT_AG_310P3 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters.setCurrentTestDescription(
				"Internal User linked sub folder and files to other site folders and files, for verifying folder path  displaying in 8hr Aggregated mail");
