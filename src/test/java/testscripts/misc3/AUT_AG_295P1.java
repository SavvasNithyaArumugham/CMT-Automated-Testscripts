 ...
 * @author Cognizant
 */
public class AUT_AG_295P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Validate the user able to see the metadata properties for any folder/file in the document library with the reviewer role - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
