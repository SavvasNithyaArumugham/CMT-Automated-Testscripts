 ...
 * @author Cognizant
 */
public class AUT_AG_306P13 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Part2:Verify the user not receives the activity email immediately, if the internal user link sub folder into other site folders when the Notifications is set as 'immediately'");
