 ...
 * @author Cognizant
 */
public class AUT_AG_310P1 extends TestCase {
	...
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription(
						 "Verify the folder path is displayed in aggregated activity email when the Shared folder is updated with new file inside the subfolder for 8 hours interval notification frequency."
						+ "<br>Internal User upload folder,add file in child folder and shared externally, for verifying folder path displaying in 8hr Aggregated mail");
