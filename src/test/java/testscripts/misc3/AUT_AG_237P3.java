 ...
 * @author Cognizant
 */
public class AUT_AG_237P3 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that all assets are displayed when user navigate to the asset through category menu.<br> - Part3: Now login with collaborator role and verify the added category");
