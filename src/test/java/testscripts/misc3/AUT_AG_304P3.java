...
public class AUT_AG_304P3 extends TestCase {
	...
	public void misc3_006() {
		testParameters
				.setCurrentTestDescription("ALFDEPLOY-2065_Verify Collaborator is able to rename the folder through Edit Properties window with folder name value which doesnt exist in the document library.<br>" + 
						"ALFDEPLOY-2065_Verify Collaborator is able to rename the folder through All Properties window with folder name value which doesnt exist in the document library.<br>" + 
						"ALFDEPLOY-2065_Verify Collaborator gets warning message when the folder name is renamed through All Properties window with a same folder name value which already exists in the document library.<br>" + 
						"ALFDEPLOY-2065_Verify Collaborator is able to rename the file through Edit Properties window with file name value which doesnt exist in the document library.<br>" + 
						"ALFDEPLOY-2065_Verify Collaborator is able to rename the file through All Properties window with file name value which doesnt exist in the document library.<br>" + 
						"ALFDEPLOY-2065_Verify Collaborator gets warning message when the file name is renamed through All Properties window with a same file name value which already exists in the document library.<br>" );
