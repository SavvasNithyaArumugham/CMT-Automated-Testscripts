 ...
 * @author Cognizant
 */
public class AUT_AG_308P6 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email after 8 hour, if the Notifications is set as 'Every 8 Hours' while updating shared root folder"
