...
public class AUT_AG_253 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_037()
	{
		testParameters.setCurrentTestDescription("Verify that user should not able to see site in Moveto pop up in which user is not a member");
	...
	public void executeTest() {
		...
		System.out.println(recentSiteNamesList);
