...
public class AUT_AG_209 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void misc3_003() {
		testParameters
				.setCurrentTestDescription("Verify user is able to see 'follow' link in asset detail/preview page");
