 ...
 * @author Cognizant
 */
public class AUT_AG_309P6 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email after 24 hour, if the Notifications is set as 'Every 24 Hours' while updating shared root folder"
