 ...
 * @author Cognizant
 */
public class AUT_AG_297P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Validate the user with reviewer role not able to preview the file - Part2: Login has reviewer and check files are visible");
