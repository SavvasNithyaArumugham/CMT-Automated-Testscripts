...
public class AUT_AG_278 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_060()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to see all the sites in My site dashlet when user login ");
	...
	public void executeTest() {
		...
		homePageTest.verifyFilteredAllSitesInMySitesDashlet();
