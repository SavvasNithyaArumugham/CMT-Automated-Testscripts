 ...
 * @author Cognizant
 */
public class AUT_AG_309P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the folder path is not displayed in aggregated activity email when the Shared root folder is updated for 24 hour interval notification frequency."
						+ "<br>Internal User upload folder,add file and shared externally, for verifying folder path not displaying in 24hr Aggregated mail");
	...
	public void executeTest() {
		...
		String properties = dataTable.getData("Sharebox", "ShareboxFieldsData").replaceAll("Name:Craft",
				"Name:24hrRootFolderTest"+ "_" +date);
