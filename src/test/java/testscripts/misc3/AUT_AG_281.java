...
public class AUT_AG_281 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc3_062()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to navigate to site dashboard when click on site name from MySite Dashlet");
