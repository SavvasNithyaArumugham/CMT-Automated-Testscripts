 ...
 * @author Cognizant
 */
public class AUT_AG_287P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Verify that user with Coordinator role have permissions to Deletecontent created by another user<br> - Part1: Invite users to join site and uploaded file into same site");
