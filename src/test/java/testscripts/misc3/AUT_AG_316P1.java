 ...
 * @author Cognizant
 */
public class AUT_AG_316P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the folder path is displayed in aggregated activity email when the Shared subfolder is available inside the unshared root folder is updated with new file inside the subfolder for 1 hour interval notification frequency."
