 ...
 * @author Cognizant
 */
public class AUT_AG_296P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void misc3()
	{
		testParameters.setCurrentTestDescription("Validate the user with reviewer role not able to delete the file/folder - Part2: Login has reviewer and check files are visible");
