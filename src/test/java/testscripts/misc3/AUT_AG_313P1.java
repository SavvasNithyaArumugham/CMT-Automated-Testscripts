 ...
 * @author Cognizant
 */
public class AUT_AG_313P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the folder path is not displayed in aggregated activity email when the Shared subfolder is available inside the unshared root folder is updated with new file by external user inside the subfolder for 1 hour interval notification freq"
						+"<br>Internal User upload 2 child folder and shared externally, for verifying folder path not displaying in 1hr Aggregated mail");
