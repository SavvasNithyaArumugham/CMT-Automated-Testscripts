 ...
 * @author Cognizant
 */
public class AUT_AG_322 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters.setCurrentTestDescription("1.Verify a French translation for My files content by performing attach, promote, demote and detach");
