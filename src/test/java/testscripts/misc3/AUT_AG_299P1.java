 ...
 * @author Cognizant
 */
public class AUT_AG_299P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_120()
	{
		testParameters.setCurrentTestDescription("Validate the user with reviewer role not able to edit properties for a file/folder - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
