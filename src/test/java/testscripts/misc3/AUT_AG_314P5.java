 ...
 * @author Cognizant
 */
public class AUT_AG_314P5 extends TestCase {

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the notification email immediately, if the Notifications is set as 'Immediately' while Shared folder is updated with new folder,inside the subfolder"
