 ...
 * @author Cognizant
 */
public class AUT_AG_306P14 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Part1:Verify the user not receives the activity email immediately, if the internal user link file into other site  when the Notifications is set as 'immediately'");
