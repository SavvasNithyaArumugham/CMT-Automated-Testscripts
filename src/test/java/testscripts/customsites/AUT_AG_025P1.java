...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("To verify that user receives an email notification, when site manager invites the user to Join a site - Part1: Invite User");
