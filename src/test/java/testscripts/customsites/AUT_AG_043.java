...
public class AUT_AG_043 extends TestCase{
	...
	@Test
	public void CUSTOMSITES_025()
	{
		testParameters.setCurrentTestDescription("Verify that site manager is able to customize site dashboard for Collaboration site with 'Three columns: wide centre'");
	...
	public void executeTest() {
		...
		String layoutPosition = dataTable.getData("Home", "DashBoardName");
		...
		sitesDashboardPage.changeLayout(layoutOption, layoutPosition);
	}
