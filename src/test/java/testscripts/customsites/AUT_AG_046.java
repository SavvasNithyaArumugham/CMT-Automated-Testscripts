...
public class AUT_AG_046 extends TestCase{
	...
	@Test
	public void runAUT_AG_046()
	{
		testParameters.setCurrentTestDescription("Verify that site manager is able to customize site dashboard for Program site with 'Three columns: wide centre'");
