...
public class AUT_AG_050 extends TestCase{
	...
	@Test
	public void runAUT_AG_050()
	{
		testParameters.setCurrentTestDescription("Verify that site manager is able to customize site dashboard for Program Component site with 'Four columns'.");
