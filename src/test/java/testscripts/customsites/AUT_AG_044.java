...
public class AUT_AG_044 extends TestCase{
	...
	@Test
	public void CUSTOMSITES_026()
	{
		testParameters.setCurrentTestDescription("Verify that site manager is able to customize site dashboard for Collaboration site with 'Four columns'");
