...
public class AUT_AG_049 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that site manager is able to customize site dashboard for Program Component site with 'Three columns: wide centre'.");
