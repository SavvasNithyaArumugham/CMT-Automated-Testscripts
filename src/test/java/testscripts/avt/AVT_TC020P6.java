...
public class AVT_TC020P6 extends TestCase {
	...
	public void AVT_001() {
		testParameters.setCurrentTestDescription(
				"1.Verify user(Consumer/Reviewer)is not able to view Streaming media option for JSON file created by others when user is not member of Media Developers group"
						+ "<br>2.Verify user(Consumer/Reviewer) is not able to view Streaming media option under created when user is not  member of Media Developers group");
