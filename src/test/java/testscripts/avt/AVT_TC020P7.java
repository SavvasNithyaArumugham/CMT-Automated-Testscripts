...
public class AVT_TC020P7 extends TestCase {
	...
	public void AVT_001() {
		testParameters.setCurrentTestDescription(
				"1.Verify user(Contributor)is not able to view Streaming media option for JSON file created by others when user is not member of Media Developers group");
