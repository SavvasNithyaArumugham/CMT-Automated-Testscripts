...
public class AUT_AG_033 extends TestCase
{
	...
	@Test
	public void proofhq_19()
	{
		testParameters.setCurrentTestDescription("Verifying the alfresco Shared files feature for proof related files/folders is working properly");
