 ...
 * @author Cognizant
 */
public class AUT_AG_004P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void proofhq_04() {
		testParameters.setCurrentTestDescription(
				"Reviewer role should not be able to create a proof via alfresco.<br> Part 1: create Site and ivite user to site<br>"
						+ "[1]ALFDEPLOY-3008_Verify reviewer is able to create a proof without getting welcome mail to access the proof.");
	...
	public void executeTest() {
		...
		for (String file : fileNames) {
			myFilesTestObj.verifyUploadedFile(file, "");
		}
