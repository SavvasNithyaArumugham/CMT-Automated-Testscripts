...
public class AUT_AG_029 extends TestCase {
	...
	@Test
	public void proofhq_16() {
		testParameters
				.setCurrentTestDescription("Verifying the alfresco 'Link to' feature for proof related files/folders is working properly");
	...
	public void executeTest() {
		...
		if (moreSettingsOption.contains(",")) {
			...
			if (splittedMoreSetOptions != null
				...
				moreSetOption2 = "Link To";
				moreSetOption3 = "Remove Proof from ProofHQ";
			}
		} else {
			moreSetOption1 = "Create Proof in ProofHQ";
			moreSetOption2 = "Link To";
		...
		docLibPg.performLinkToOperation(siteName, folderName2);
		
		sitesPage.enterIntoDocumentLibrary();
		myFiles.openFolder(folderName2);
		
		docLibTestPage.verifyLinkedFile(fileName,
				siteName, folderName2);
