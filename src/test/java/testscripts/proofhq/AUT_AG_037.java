...
public class AUT_AG_037 extends TestCase
{
	...
	@Test
	public void proofhq_21()
	{
		testParameters.setCurrentTestDescription("Verifying the Create proof option for the files once the proof is removed");
	...
	public void executeTest()
	{
		...
		sitesPage.clickOnMoreSetting(fileName);
		sitesPageTests.verifyMoreSettingsOptionForFileOrFolderItem(fileName, moreSettingsOption1);
		sitesPageTests.verifyMoreSettingsOptionForFileOrFolderItemNegativeCase(fileName, moreSettingsOption2);
		sitesPageTests.verifyMoreSettingsOptionForFileOrFolderItemNegativeCase(fileName, moreSettingsOption3);
	}
