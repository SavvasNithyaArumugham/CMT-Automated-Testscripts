...
public class AUT_AG_005P1 extends TestCase {
	...
	public void proofhq_05() {
		testParameters.setCurrentTestDescription(
				"Consumer role not should be able to create a proof via alfresco.<br> Part 1: create Site and ivite user to site<br>"
						+ "[1]ALFDEPLOY-3008_Verify consumer is able to create a proof without getting welcome mail to access the proof.");
