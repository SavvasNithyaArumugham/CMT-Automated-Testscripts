...
public class AUT_AG_026 extends TestCase {
	...
	@Test
	public void proofhq_13() {
		testParameters
				.setCurrentTestDescription("Verifying the alfresco 'Copy to' feature for proof related files/folders is working properly");
	...
	public void executeTest() {
		...
		docLibPg.performCopyToOperation(siteName, folderName2);
