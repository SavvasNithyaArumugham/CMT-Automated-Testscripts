...
public class AUT_AG_027P4 extends TestCase {
	...
	@Test
	public void AV_002() {
		testParameters.setCurrentTestDescription("1.Verify user2 change state of lifecycle to file which is unfollowed by user 1" );
	...
	public void executeTest()
	{
     ...
     // Go to document library
		...
		UIHelper.waitForPageToLoad(driver);	
	    UIHelper.waitForPageToLoad(driver);
		driver.findElement(By.id("clickPromote-ok")).click();
