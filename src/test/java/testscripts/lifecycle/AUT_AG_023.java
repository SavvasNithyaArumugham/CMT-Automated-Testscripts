...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void LIFECYCLE_023()
	{
		testParameters.setCurrentTestDescription("Verify user is able to revert  to previous as major version of a file that is followed along with lifecycle (Digital UK Schools) attached to it");
