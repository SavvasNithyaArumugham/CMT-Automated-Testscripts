...
public class AUT_AG_027P3 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AV_002() {
		testParameters.setCurrentTestDescription("1.Verify user1 unfollows the after user2 attached a lifecycle.");
 ...
 // Site finder
	...
	//Upload a file
		...
		report.updateTestLog("User clicks Unfollow", "Status: " +"UnFollow option get clicked", Status.PASS);
	    
		//User1 Unfollow
		String Follow = "//*[@class='Unfollow-action enabled'][contains(@id,'Unfollow-document')]";
		UIHelper.waitForVisibilityOfEleByXpath(driver, Follow);
				
		WebElement w2=driver.findElement(By.xpath(Follow));
		w2.click();
		report.updateTestLog("Check whether AlfrescoAutoDemoForTest is unfollowed", "Status: " +"User1 unfollowed AlfrescoAutoDemoForTest file", Status.PASS);
