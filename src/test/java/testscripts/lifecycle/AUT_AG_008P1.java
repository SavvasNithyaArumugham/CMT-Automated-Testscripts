...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that email notification is sent to an user who updates the lifecycle status for a document<br> - Part1: Open Site and follow the uploaded file");
