...
public class AUT_AG_003 extends TestCase
{
	...
	@Test
	public void objectmodel_003()
	{
		testParameters.setCurrentTestDescription("Verify user is able to do the functionalities of 'Program Store Component' aspect for selected folder/file");
