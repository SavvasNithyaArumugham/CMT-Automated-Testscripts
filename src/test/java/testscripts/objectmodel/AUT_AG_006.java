...
public class AUT_AG_006 extends TestCase
{
	...
	@Test
	public void objectmodel_006()
	{
		testParameters.setCurrentTestDescription("Verify user is able to do the functionalities of 'QS Product Store Component' aspect for selected folder/file");
