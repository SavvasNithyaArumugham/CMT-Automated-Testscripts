...
public class AUT_AG_005 extends TestCase
{
	...
	@Test
	public void objectmodel_005()
	{
		testParameters.setCurrentTestDescription("Verify user is able to do the functionalities of 'ISBN' aspect for selected folder/file");
