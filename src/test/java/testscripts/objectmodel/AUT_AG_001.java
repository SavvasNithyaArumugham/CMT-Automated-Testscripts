...
public class AUT_AG_001 extends TestCase
{
	...
	@Test
	public void objectmodel_001()
	{
		testParameters.setCurrentTestDescription("Verify user is able to do the functionalities of 'Program' aspect for selected folder/file");
	...
	public void executeTest()
	{
		...
		doAspectFunctionality(folderName, false, true, false);
