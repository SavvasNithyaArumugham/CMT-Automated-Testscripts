...
public class AUT_AG_016P3 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verfiy user with roles (Contributor, Consumer) has no permission to add aspects to folder/file uploaded by others in document library - Part 3 - Consumer Role");
	...
	public void executeTest()
	{
		...
		for (String folderName : folderNamesList) {
			...
			sitePgTestObj.verifyManageAspectsOptionIsAvaible(folderName, "Consumer");
		}
	}
