...
public class AUT_AG_002 extends TestCase
{
	...
	@Test
	public void objectmodel_002()
	{
		testParameters.setCurrentTestDescription("Verify user is able to do the functionalities of 'Program Component' aspect for selected folder/file");
	...
	public void executeTest()
	{
        ...
        doAspectFunctionality(folderName, true, true, false);
        sitesPage.enterIntoDocumentLibrary();
        doAspectFunctionality(fileName, false, false, true);
	}
