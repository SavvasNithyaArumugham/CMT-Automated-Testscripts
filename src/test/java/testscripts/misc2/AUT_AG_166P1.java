 ...
 * @author Cognizant
 */
public class AUT_AG_166P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Deleted by the member(depending upon the role in site)<br> - Part1: Open Site and follow the uploaded file");
