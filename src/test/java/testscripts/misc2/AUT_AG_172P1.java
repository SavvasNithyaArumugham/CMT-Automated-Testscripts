 ...
 * @author Cognizant
 */
public class AUT_AG_172P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_067()
	{
		testParameters.setCurrentTestDescription("Verify that original site name is visible to the  User when Emails triggered for operation on followed documents - Part1: Open Site and follow the uploaded file");
	...
	public void executeTest()
	{
		...
		sitesPage.createSite(siteName, "No");//Modified from Yes to No as part of NALS 
