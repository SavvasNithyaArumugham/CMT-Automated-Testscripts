...
public class AUT_AG_169P3 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC169Part3()
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Edited Inline by the member(depending upon the role in site)<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
