...
public class AUT_AG_172P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that original site name is visible to the  User when Emails triggered for operation on followed documents - Part3: Navigate to the configuerd user Email ID and check Mail has Site name displayed");
