 ...
 * @author Cognizant
 */
public class AUT_AG_190 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_085()
	{
		testParameters.setCurrentTestDescription("Verify that user is able view the error message when try to convert word to xml and rule is not applied on folder");
	...
	public void executeTest()
	{
		...
		homePageObj.selectFileLinkFrmFailedReport(fileLink);
		sitesPage.enterIntoDocumentLibrary();
		
		if(docLibPg.isXMLTransFileIsAvailable(catlogueXmlName)){
