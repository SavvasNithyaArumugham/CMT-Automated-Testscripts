...
public class AUT_AG_194P3 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC194Part3()
	{
		testParameters.setCurrentTestDescription("Able to follow templates, when a template is edited, then the follower will receive an indicaton via email<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
