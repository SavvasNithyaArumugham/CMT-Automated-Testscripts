...
public class AUT_AG_173P2 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_068()
	{
		testParameters.setCurrentTestDescription("Verify that the text 'To review content please go to' and link has been removed from email notification when user performs 'bulk download' operation from search results<br> - Part2: Navigate to the configuerd user Email ID and check for the bulk download email");
	...
	public void executeTest() {
		...
		String staticMessageVal1 = "DOWNLOAD COMPLETED Id";
			...
			if(message!=null)
			{
				if(message.contains(":"))
				{
					...
					if(splittedMessage!=null)
					{
						...
						pearsonMailObj.commonMethodForSearchMail("Bulk Download", finalMessage);
						...
						pearsonMailTestObj.verifyMailBodyText("Bulk Download",expectedBulkDownloadMailMessage);
