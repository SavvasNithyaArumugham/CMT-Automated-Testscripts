 ...
 * @author Cognizant
 */
public class AUT_AG_189 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_084()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to convert multiple file from 'word to xml' from Selected Items menu  at folder level");
