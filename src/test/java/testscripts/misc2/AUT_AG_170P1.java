...
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that user did not receive any Email notification when user perform any operation other than Edit Offline,Edit Inline,Upload New version and Delete Document<br> - Part1: Open Site and follow the uploaded file");
