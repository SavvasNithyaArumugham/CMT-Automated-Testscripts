 ...
 * @author Cognizant
 */
public class AUT_AG_198P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_091()
	{
		testParameters.setCurrentTestDescription("Asset will have the associated detail of the change <br> - Part2:Follow the same file with another site member and perform 'Upload New Version'");
