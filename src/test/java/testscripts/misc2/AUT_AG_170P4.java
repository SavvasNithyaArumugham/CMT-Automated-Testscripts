...
public class AUT_AG_170P4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user did not receive any Email notification when user perform any operation other than Edit Offline,Edit Inline,Upload New version and Delete Document<br> - Part4: Navigate to the first user registerd Email Id who followed the document earlier");
