 ...
 * @author Cognizant
 */
public class AUT_AG_182 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_077()
	{
		testParameters.setCurrentTestDescription("Verify that when User add a folder to my favorite from My Files then it will show under My Favorite option ");
