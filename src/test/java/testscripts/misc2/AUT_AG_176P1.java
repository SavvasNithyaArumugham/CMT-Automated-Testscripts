...
public class AUT_AG_176P1 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_071()
	{
		testParameters.setCurrentTestDescription("To verify that user receive email notification when a workflow task is created for a file (From Document Library)"
