 ...
 * @author Cognizant
 */
public class AUT_AG_179 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_074()
	{
		testParameters.setCurrentTestDescription("Verify that when User add a file to my favorite from My Files then it will show under My Favorite option ");
