 ...
 * @author Cognizant
 */
public class AUT_AG_193P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Able to follow templates, when a template is edited, then the follower will receive an indicaton in their dashboard<br> - Part2:Follow the same file with another site member and perform 'Delete'");
