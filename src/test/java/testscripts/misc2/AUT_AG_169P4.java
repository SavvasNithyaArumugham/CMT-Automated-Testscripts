...
public class AUT_AG_169P4 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC169Part4()
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Edited Inline by the member(depending upon the role in site)<br> - Part4: Navigate to the first user registerd Email Id who followed the document earlier");
