...
public class AUT_AG_112 extends TestCase{
	...
	@Test
	public void MISC2_008(){
		testParameters.setCurrentTestDescription("Verify user is not able to view Blog posts information in 'Content I'm editing' dashlet of users dashboard");
	...
	public void executeTest() {
		...
		homePageTest.verifyUserActivityDisplayedInContentEditingDashlet("Blog Post");
	}
