 ...
 * @author Cognizant
 */
public class AUT_AG_195P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("When a document is being followed, then the follower will receive an indication by email that a new version has been uploaded<br> - Part2:Follow the same file with another site member and perform 'Delete'");
