 ...
 * @author Cognizant
 */
public class AUT_AG_168P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Uploaded New Version by the member(depending upon the role in site)<br> - Part2:Follow the same file with another site member and perform edit offline");
