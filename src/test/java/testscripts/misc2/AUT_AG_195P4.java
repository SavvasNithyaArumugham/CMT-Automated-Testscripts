...
public class AUT_AG_195P4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("When a document is being followed, then the follower will receive an indication by email that a new version has been uploaded<br> - Part4: Navigate to the first user registerd Email Id who followed the document earlier");
