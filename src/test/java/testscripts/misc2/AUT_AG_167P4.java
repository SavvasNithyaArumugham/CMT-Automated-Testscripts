...
public class AUT_AG_167P4 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Edit Offline by the member(depending upon the role in site)<br> - Part4: Navigate to the first user registerd Email Id who followed the document earlier");
