 ...
 * @author Cognizant
 */
public class AUT_AG_173P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that the text 'To review content please go to' and link has been removed from email notification when user performs 'bulk download' operation from search results<br> - Part1: Perform 'bulk download' operation from search results");
