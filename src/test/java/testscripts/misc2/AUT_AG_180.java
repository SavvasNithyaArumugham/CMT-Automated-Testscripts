 ...
 * @author Cognizant
 */
public class AUT_AG_180 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_075()
	{
		testParameters.setCurrentTestDescription("Verify that when User add a folder to my favorite from Document Library then it will show under My Favorite option ");
