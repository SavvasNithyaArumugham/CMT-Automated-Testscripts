...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void MISC2_006()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to see text 'Editing started at [N (minutes/hours//day/month)] ago in [S (site)] in 'Content I'm editing' dashlet below the file name that was locked.");
	...
	public void executeTest()
	{
		...
		homePageTest.verifyFormatOfContentEditingDashlet("just now in");
	}
