 ...
 * @author Cognizant
 */
public class AUT_AG_141P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify if sitemanager is able to delete file & folder created by another user<br> - Part1: Login with User A and Open Site and create a file & folder");
