 ...
 */
public class AUT_AG_196P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Able to follow an Asset, when any change occurs (edit, new version, move, copy or delete), then the follower will receive and indication of this within the dashboard<br> - Part1: Open Site and follow the uploaded file");
