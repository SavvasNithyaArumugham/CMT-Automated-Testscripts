...
public class AUT_AG_119P3 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("To verify that a record Is displayed in the 'My Activity' dashlet, when a user leaves the site - Part 3");
