...
public class AUT_AG_195P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("When a document is being followed, then the follower will receive an indication by email that a new version has been uploaded<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
