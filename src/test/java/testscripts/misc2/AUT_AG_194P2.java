 ...
 * @author Cognizant
 */
public class AUT_AG_194P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC194P2()
	{
		testParameters.setCurrentTestDescription("Able to follow templates, when a template is edited, then the follower will receive an indicaton via email<br> - Part2:Follow the same file with another site member and perform 'Delete'");
