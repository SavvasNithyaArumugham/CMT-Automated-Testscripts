...
public class AUT_AG_174P2 extends TestCase{
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void MISC2_069()
	{
		testParameters.setCurrentTestDescription("Verify that the text 'To review content please go to' and link has been removed from email notification when user performs 'metadata template download' operation from search results<br> - Part2: Navigate to the configuerd user Email ID and check for the Metadata template download email");
			...
			if(message!=null)
			{
				if(message.contains(":"))
				{
					...
					if(splittedMessage!=null)
					{
						...
						pearsonMailObj.commonMethodForSearchMail("Metadata Template Download", finalMessage);
						...
						pearsonMailTestObj.verifyMailBodyText("Metadata Template Download",expectedBulkDownloadMailMessage);
