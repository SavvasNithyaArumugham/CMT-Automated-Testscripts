 ...
 *
 */
public class AUT_AG_116P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify Memberships Records is displayed on selecting Membership value in the Dropdown on the Site Activites Dashlet - User 2 Join the site");
