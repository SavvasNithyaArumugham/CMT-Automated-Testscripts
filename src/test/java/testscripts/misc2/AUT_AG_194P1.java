 ...
 * @author Cognizant
 */
public class AUT_AG_194P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC194P1()
	{
		testParameters.setCurrentTestDescription("Able to follow templates, when a template is edited, then the follower will receive an indicaton via email<br> - Part1: Open Site and follow the uploaded file");
