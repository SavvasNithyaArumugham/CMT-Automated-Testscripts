 ...
 * @author Cognizant
 */
public class AUT_AG_140P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that when User perform delete operation on followed file than duplicate file name should not get appeared on the delete window - Part1: Open Site and follow the uploaded file");
