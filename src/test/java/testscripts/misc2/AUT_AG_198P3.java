...
public class AUT_AG_198P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription(" Asset will have the associated detail of the change <br> - Part3: Navigate to the configuerd user Email ID and check Mail");
