 ...
 * @author Cognizant
 */
public class AUT_AG_203P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that user should be able to Follow the same file which was already Followed by another site member<br> - Part1: Open Site and follow the uploaded file");
