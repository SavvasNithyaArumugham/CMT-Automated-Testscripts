...
public class AUT_AG_168P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that all site members receives an Email notification who are following the same asset,when asset get Uploaded New Version by the member(depending upon the role in site)<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
