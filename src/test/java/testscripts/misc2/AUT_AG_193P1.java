 ...
 * @author Cognizant
 */
public class AUT_AG_193P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Able to follow templates, when a template is edited, then the follower will receive an indicaton in their dashboard<br> - Part1: Open Site and follow the uploaded file");
