...
public class AUT_AG_013 extends TestCase {
	...
	@Test
	public void transformations_13() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform 'vnd.apple.numbers - (.numbers)' file to below format files"
						+ "<br>-eps" + "<br>-pdf" + "<br>-bmp" + "<br>-cgm" + "<br>-gif" + "<br>-ief" + "<br>-jpeg"
						+ "<br>-png" + "<br>-tiff");
