...
public class AUT_AG_001 extends TestCase {
	...
	@Test
	public void transformations_01() {

		testParameters.setCurrentTestDescription("1. Verify that user is able to apply rules on a folder"
				+ "<br>2. Verify that user is able to transform 'eps' file to below format files" + "<br>-jpeg"
				+ "<br>-bmp" + "<br>-tiff" + "<br>-gif" + "<br>-png" + "<br>-ief" + "<br>-cgm" + "<br>-jp2");
