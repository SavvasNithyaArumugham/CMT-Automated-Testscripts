...
public class AUT_AG_037 extends TestCase {
	...
	@Test
	public void transformations_37() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform '-text/plain - txt' file to below format files"+ "<br>-rtf"+ "<br>-msword"
						+ "<br>-jpeg" + "<br>-bmp" + "<br>-tiff" + "<br>-gif" + "<br>-png" + "<br>-ief" + "<br>-cgm");
