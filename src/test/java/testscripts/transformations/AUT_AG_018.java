...
public class AUT_AG_018 extends TestCase {
	...
	@Test
	public void transformations_18() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform 'ms-outlook - msg' file to below format files"
						+ "<br>-msword" + "<br>-cgm" + "<br>-gif" + "<br>-ief" + "<br>-jpeg" + "<br>-png" + "<br>-tiff");
