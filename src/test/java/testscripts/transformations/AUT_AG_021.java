...
public class AUT_AG_021 extends TestCase {
	...
	@Test
	public void transformations_21() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform 'openxmlformats-officedocument.presentationml.presentation - pptx' file to below format files"
						+ "<br>-pdf" + "<br>-cgm" + "<br>-gif" + "<br>-ief" + "<br>-jpeg" + "<br>-png" + "<br>-tiff");
