...
public class AUT_AG_002 extends TestCase {
	...
	@Test
	public void transformations_02() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform 'ai' file to below format files" + "<br>-jpeg" + "<br>-bmp"
						+ "<br>-tiff" + "<br>-gif" + "<br>-png" + "<br>-ief" + "<br>-cgm" + "<br>-jp2");
