...
public class AUT_AG_039 extends TestCase {
	...
	@Test
	public void transformations_39() {
		testParameters.setCurrentTestDescription(
				"Verify that user is able to transform -below file to 'plain text' format files" + "<br>-etx" + "<br>-markdown - md"
						+ "<br>-jsp - jsp" + "<br>-richtext - rtx"+ "<br>-tab-separated-values - tsv");
