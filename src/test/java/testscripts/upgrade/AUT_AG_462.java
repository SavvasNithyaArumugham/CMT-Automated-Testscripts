 ...
 * @author Cognizant
 */
public class AUT_AG_462 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC462()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform Filtered  Search based on Size.");
