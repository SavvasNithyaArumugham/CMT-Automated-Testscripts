 ...
 * @author Cognizant
 */
public class AUT_AG_464 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify that user is able to see all the dashlets after clicking on search manager");
