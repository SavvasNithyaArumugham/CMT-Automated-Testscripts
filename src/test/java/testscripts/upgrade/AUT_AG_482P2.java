 ...
 *
 */
public class AUT_AG_482P2 extends TestCase{

	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_482P2(){
		testParameters.setCurrentTestDescription("Using share admin tools,Verify Administrator is able to delete a site from a single admin screen - Delete a Site");
