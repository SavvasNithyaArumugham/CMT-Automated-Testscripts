...
public class AUT_AG_467 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_467()
	{
		testParameters.setCurrentTestDescription("Verify User is able to delete the newly created Filter using Search Manager");
	...
	public void executeTest()
	{
		...
		String filterName = dataTable.getData("Search", "CreateFilterDetails");
		searchObj.deleteCreatedFileter(filterName);
	}
