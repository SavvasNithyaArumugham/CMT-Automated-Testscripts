 ...
 * @author Cognizant
 */
public class AUT_AG_477 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_477()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform instant search for Document");
