 ...
 * @author Cognizant
 */
public class AUT_AG_478 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_478()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform instant search for Sites");
