 ...
 * @author Cognizant
 */
public class AUT_AG_474P1 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_474P1()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to Start Workflow for the document  within search results page.");
