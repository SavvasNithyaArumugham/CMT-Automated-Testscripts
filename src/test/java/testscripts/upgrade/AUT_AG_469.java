 ...
 * @author Cognizant
 */
public class AUT_AG_469 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_469()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform Download within the search results page ");
