...
public class ALFDEPLOY_2236_TC003 extends TestCase {
	...
	public void COLLECTIONS_009() {
		testParameters.setCurrentTestDescription(
				"Following the creation of a sequence object can see that the External ID metadata is populated with a value starting with an 'L' followed by one or more digits");
	...
	public void executeTest() {
		...
		collectionPg.enterBasicDataForSequenceObject(collectionObjectDataArray[0], collectionObjectDataArray[1],
				collectionObjectDataArray[2], collectionObjectDataArray[3], collectionObjectDataArray[4]);
