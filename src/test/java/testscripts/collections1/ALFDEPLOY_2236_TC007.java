...
public class ALFDEPLOY_2236_TC007 extends TestCase {
	...
	public void COLLECTIONS_013() {
		...
		testParameters.setCurrentTestDescription("Following the creation of a composite object can see that the External ID metadata is populated with a value starting with an 'L' followed by one or more digits");
