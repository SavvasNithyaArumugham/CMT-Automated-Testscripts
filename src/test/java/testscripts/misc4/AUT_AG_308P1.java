...
public class AUT_AG_308P1 extends TestCase {
	...
	@Test
	public void misc4_008() {
		testParameters
				.setCurrentTestDescription("Verify that Reviewer user can able to view the  link details. Part 1: Create new Link");
	...
	public void executeTest() {
		...
		AlfrescoMyActivitiesPage myActivityPage = new AlfrescoMyActivitiesPage(
				scriptHelper);
		if (myActivityPage.checkCreatedLink()) {
			myActivityPage.deleteLink();
		}

		myActivityPage.createLink();
