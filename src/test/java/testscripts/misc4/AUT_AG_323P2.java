...
public class AUT_AG_323P2 extends TestCase{
	...
	public void misc4_022()
	{
		testParameters.setCurrentTestDescription("To check if sitemanager is able to<br>"
				...
				+ "2.set same role to both users using 'Set All Roles to' (Note:External & Internal user should get email notification for added to the site)<br> - Part2: Navigate to the configuerd user Email ID and check Mail");
