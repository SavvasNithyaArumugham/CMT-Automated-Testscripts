...
public class AUT_AG_309P2 extends TestCase{
	...
	public void misc4_009(){
		testParameters.setCurrentTestDescription("Verify that Reviewer user can able to leave from the site. Part2: Leave site");
	...
	public void executeTest() {
		...
		try {
			...
			siteDashboardPage.toLeaveASite(siteNameValue);
		} catch (Exception e) {
