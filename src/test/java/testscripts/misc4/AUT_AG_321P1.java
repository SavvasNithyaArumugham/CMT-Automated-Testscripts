...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void misc4_020()
	{
		testParameters.setCurrentTestDescription("To check if internal user is added to the site directly when sitemanager adds internal user as contributor to the site (Note:Internal user should get email notification for added to the site)<br> - Part1: Invite/Add internal user to site using 'Coordinator' role and check invited user directly added to site through 'Site Members'");
