 ...
 * @author Cognizant
 */
public class AUT_AG_301P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that Reviewer user is able to make site as favorites from from Document Library - Part2: Login has reviewer and check files are visible");
