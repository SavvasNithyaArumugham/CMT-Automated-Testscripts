...
public class AUT_AG_325P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To check if sitemanager can change roles for internal users of the site individually<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
