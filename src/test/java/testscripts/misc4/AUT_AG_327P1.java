 ...
 * @author Cognizant
 */
public class AUT_AG_327P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc4_026()
	{
		testParameters.setCurrentTestDescription("To check if internal users can be added to private site by sitemanager<br> - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
