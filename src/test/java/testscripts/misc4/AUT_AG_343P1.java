 ...
 * @author Cognizant
 */
public class AUT_AG_343P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc4_039()
	{
		testParameters.setCurrentTestDescription("Reviewer user can able to Unlike the File/folder from Document Library - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
