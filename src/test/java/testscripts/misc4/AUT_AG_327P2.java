...
public class AUT_AG_327P2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To check if internal users can be added to private site by sitemanager<br> - Part2: Navigate to the configuerd user Email ID and check Mail");
