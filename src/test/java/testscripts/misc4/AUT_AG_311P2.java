...
public class AUT_AG_311P2 extends TestCase{
	...
	@Test
	public void misc4_011(){
		testParameters.setCurrentTestDescription("Verify that Reviewer user can able to view the details about the Site Contributor Breakdown  dashlet. Part2 : Verify user is able to add dashlet");
