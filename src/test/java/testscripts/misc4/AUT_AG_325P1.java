...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void misc4_024()
	{
		testParameters.setCurrentTestDescription("To check if sitemanager can change roles for internal users of the site individually<br> - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
	...
	public void executeTest()
	{
		...
		sitesPage.setRolesIndividuallyToUsersInIviteUseToSte(siteName);
