...
public class AUT_AG_378P2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Validate Review and approve Archive submission task mail for Line of business English for rejected task <br> Part2: Reject task and Check mail");
	...
	public void executeTest() {
		...
		pearsonMailObj.searchMailWithSubjectTitle("Archive Pooled Task"+" "+message+" has been Rejected");
		
		pearsonMailObjTest.verifyMailSubAndBodyForRevAppSubTask(message+" has been Rejected");
		
		pearsonMailObjTest.verifyMailSubAndBodyForRevAppSubTask(message);
	}
