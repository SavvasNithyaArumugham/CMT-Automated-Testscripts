 ...
 * @author Cognizant
 */
public class AUT_AG_343P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Reviewer user can able to Unlike the File/folder from Document Library - Part2: Login has reviewer and check files are visible");
