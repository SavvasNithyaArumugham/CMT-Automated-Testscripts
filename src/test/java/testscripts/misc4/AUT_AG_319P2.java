...
public class AUT_AG_319P2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To check if internal user is added to the site directly when sitemanager adds internal user as collaborator to the site (Note:Internal user should get email notification for added to the site)<br> - Part2: Navigate to the configuerd user Email ID and check Mail");
