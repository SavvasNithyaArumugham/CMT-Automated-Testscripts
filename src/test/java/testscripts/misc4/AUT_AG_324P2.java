...
public class AUT_AG_324P2 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To check if sitemanager can change same role for internal users using 'Set All Roles to'<br> - Part2: Navigate to the configuerd user Email ID and check Mail");
