 ...
 * @author Cognizant
 */
public class AUT_AG_397P4 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("ALFDEPLOY-2922_Verify Download button is visible in case where Manager has created a file and other then Manager and Reviewer role user becomes owner, afterwards Manager assigned Reviewer role to that user.<br>"+
				"ALFDEPLOY-2922_Verify for zip file, Download button is not visible when manager changes users( Coordinator/Collaborator/Contributor/Consumer )role to Reviewer<br>"+
				"ALFDEPLOY-2922_Verify for zip file , Download button is visible to user who is Manager/Coordinator/Collaborator/Contributor/Consumer at Site .<br>"+
				"ALFDEPLOY-2922_Verify Download option is visible for Coordinator role at site in document file preview page.<br>");
