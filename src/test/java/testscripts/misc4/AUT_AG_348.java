 ...
 */
public class AUT_AG_348 extends TestCase {
	
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc4_044()
	{
		testParameters.setCurrentTestDescription("Verify that duplicate files should not be present on Upload Window on Checkin Operation<br>"
				+"Verify that Upload Window is closed automatically once file are uploaded");
