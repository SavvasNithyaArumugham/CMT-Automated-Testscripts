 ...
 * @author Cognizant
 */
public class AUT_AG_302P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void misc4_002()
	{
		testParameters.setCurrentTestDescription("Verify that Reviewer user is able to make site as unfavorites from from Document Library - Part1: Invite/Add internal user to site using 'Manager' role and check invited user directly added to site through 'Site Members'");
