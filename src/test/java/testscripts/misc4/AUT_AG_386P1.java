 ...
 * @author Cognizant
 */
public class AUT_AG_386P1 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_065P1()
	{
		testParameters.setCurrentTestDescription("Verify whether Download option for each file is in frame- Part1: Share a folder using sharebox option");
