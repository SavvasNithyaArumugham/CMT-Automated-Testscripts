 ...
 * @author Cognizant
 */
public class AUT_AG_382 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_051()
	{
		testParameters.setCurrentTestDescription("verify whether user is able to upload/create files from View Details page for incomplete sharing folder");
	...
	public void executeTest()
	{
	   ...
	   String folderName= dataTable.getData("MyFiles", "CreateFolder");
		...
		//Select view Details
		 ...
		 docDetailsPageTest.verifyShareBoxIncompleteBannerisDisplayed(folderName);	
