...
public class AUT_AG_310P1 extends TestCase {
	...
	public void misc4_010() {
		testParameters
				.setCurrentTestDescription("Verify that Reviewer user can able to view the details about the Site File Type Breakdown dashlet. Part 1: Create site and invite a member as reviewer");
