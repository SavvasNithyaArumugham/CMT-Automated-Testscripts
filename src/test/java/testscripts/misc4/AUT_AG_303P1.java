...
public class AUT_AG_303P1 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void misc4_003() {
		testParameters
				.setCurrentTestDescription("Verify that Reviewer user can able to view the calendar event - Part 1: Create a site and add reviwer");
