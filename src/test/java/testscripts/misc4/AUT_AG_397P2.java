 ...
 * @author Cognizant
 */
public class AUT_AG_397P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("ALFDEPLOY-2922_Verify Download option is visible for Collaborator role at site in document file preview page.<br>"+
				"ALFDEPLOY-2922_Verify Download option is not visible for Reviwer role at site in document file preview page.<br>"+
				"ALFDEPLOY-2922_Verify Download button is not visible to user who has Collaborator role at Site and has assigned Reviewer role at Asset by the site manager.<br>");
