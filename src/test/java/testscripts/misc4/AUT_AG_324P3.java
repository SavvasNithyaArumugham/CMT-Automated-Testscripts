...
public class AUT_AG_324P3 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("To check if sitemanager can change same role for internal users using 'Set All Roles to'<br> - Part3: Navigate to the configuerd user Email ID and check Mail");
