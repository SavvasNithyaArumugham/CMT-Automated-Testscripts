...
public class AUT_AG_305P1 extends TestCase {
	...
	public void misc4_005() {
		testParameters
				.setCurrentTestDescription("Verify that Reviewer user can view wiki page versions - Part 1: Create a site and add reviwer");
	...
	public void executeTest() {
		...
		String content = dataTable.getData("MyActivities", "Version");
		...
		myActivityPage.editWikiPage(content);
	}
