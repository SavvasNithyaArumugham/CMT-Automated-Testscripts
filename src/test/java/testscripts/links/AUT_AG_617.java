 ...
 *
 */
public class AUT_AG_617 extends TestCase{

	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_048()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to view the folder along with seven subfolders and files when it is linked to deep folder hierarchy");
