 ...
 * @author Cognizant
 */
public class AUT_AG_066P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_018()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'Selected item' drop down with collaborator role on selecting multiple files - Open site with collaborator role and create multiple files in Document Library and invite other user to site");
