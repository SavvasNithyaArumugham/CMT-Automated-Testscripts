 ...
 * @author Cognizant
 */
public class AUT_AG_078P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC78Part1()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'selected items' drop down with consumer role on selecting multiple folders - Open site with consumer role and create multiple folders in Document Library and invite other user to site");
