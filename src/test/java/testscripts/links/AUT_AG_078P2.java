 ...
 * @author Cognizant
 */
public class AUT_AG_078P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC78Part2()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'selected items' drop down with consumer role on selecting multiple folders");
	...
	public void executeTest()
	{
		...
		docLibPg.selectAllItems("Multiple folders");
