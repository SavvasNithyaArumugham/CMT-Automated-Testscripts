 ...
 * @author Cognizant
 */
public class AUT_AG_071P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC71Part1()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'document action' with collaborator role for a file - Open site with collaborator role and create file in Document Library and invite other user to site");
