 ...
 *
 */
public class AUT_AG_619 extends TestCase{

	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_050()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to view the folder along with thirteen subfolders and files when it is linked to deep folder hierarchy");
	...
	public void executeTest() {
		...
		sitesPage.clickOnMoreSetting("RootFolder");			
		sitesPage.clickOnMoreOptionLink("RootFolder");		
		UIHelper.waitFor(driver);
		UIHelper.waitFor(driver);		
		docLibPage.linkFileIntoAnotherSite("RootFolder", targetSiteName);		
		sitesPage.clickOnViewDetails("RootFolder");		
