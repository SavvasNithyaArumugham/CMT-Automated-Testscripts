 ...
 * @author Cognizant
 */
public class AUT_AG_079P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC70Part2()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'selected items' drop down with consumer role on selecting a file and folder");
	...
	public void executeTest()
	{
		...
		docLibPg.selectAllItems("Multiple files and folders");
