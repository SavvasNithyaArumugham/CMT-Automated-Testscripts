 ...
 * @author Cognizant
 */
public class TC67P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_064()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'Selected item' drop down with consumer role on selecting multiple files - Open site with consumer role and create multiple files in Document Library and invite other user to site");
