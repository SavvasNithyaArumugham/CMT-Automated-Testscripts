...
public class TC266 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC266()
	{
		testParameters.setCurrentTestDescription("Verify the 'Batch Publish' option is available in selected items drop down when selecting folders or file or Folders with files in documents library page. ");
