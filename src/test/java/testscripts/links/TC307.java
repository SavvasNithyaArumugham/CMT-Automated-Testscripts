...
public class TC307 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_034()
	{
		testParameters.setCurrentTestDescription("Verify the user is navigated to Original file location  on clicking 'Original' files Present under 'Location' Field");
