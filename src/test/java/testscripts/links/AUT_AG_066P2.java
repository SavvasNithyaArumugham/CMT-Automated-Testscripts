 ...
 * @author Cognizant
 */
public class AUT_AG_066P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'Selected item' drop down with collaborator role on selecting multiple files");
