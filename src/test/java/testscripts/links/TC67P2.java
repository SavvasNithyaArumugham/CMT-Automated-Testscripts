 ...
 * @author Cognizant
 */
public class TC67P2 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'Selected item' drop down with consumer role on selecting multiple files");
