 ...
 * @author Cognizant
 */
public class AUT_AG_079P1 extends TestCase
{
private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runTC79Part1()
	{
		testParameters.setCurrentTestDescription("Verify that 'Link to' option is visible under 'selected items' drop down with consumer role on selecting multiple files and folders - Open site with consumer role and create multiple files & folders in Document Library and invite other user to site");
