 ...
 *
 */
public class AUT_AG_618 extends TestCase{

	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void LINKS_049()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to view the folder along with ten subfolders and files when it is linked to deep folder hierarchy");
