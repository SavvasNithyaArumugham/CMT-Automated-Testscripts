...
public class AUT_AG_025 extends TestCase {
	...
	@Test
	public void AUT_AG_025() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify the lifecycle name-Image Optimization is visible upon clicking Attach lifecycle for files other than image from More option or file preview page or selected items of Shared files");
