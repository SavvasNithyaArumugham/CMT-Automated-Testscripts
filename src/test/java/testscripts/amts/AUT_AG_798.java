...
public class AUT_AG_798 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AMTS_014() {
		testParameters
				.setCurrentTestDescription("To Verify whether system allows the user to Convert the image gif file differenet formats like png, tiff, gif, jpeg");
