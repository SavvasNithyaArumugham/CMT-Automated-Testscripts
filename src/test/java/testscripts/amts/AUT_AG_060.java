...
public class AUT_AG_060 extends TestCase {
	...
	@Test
	public void runTCAUT_AG_060() {
		testParameters
				.setCurrentTestDescription("Verify that 'Request placed in queue' message is displayed after applying the transformation for a profile and transform svg to png");
