...
public class AUT_AG_024 extends TestCase {
	...
	@Test
	public void AUT_AG_024() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify the presence of lifecycle name-Image Optimization upon clicking Attach lifecycle for normal folder from More option or file preview page or selected items of Shared files");
	...
	public void executeTest() {
		...
		for(int i=1;i<folderNonOptimized.length;i++)
		{
			...
			else
			{
				...
				if(i%2==0)
				{			
					//Perform attach lifecycle via selected items			
