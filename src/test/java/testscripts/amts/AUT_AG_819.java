...
public class AUT_AG_819 extends TestCase {
	...
	public void AMTS_032() {
		testParameters
				.setCurrentTestDescription("To Verify whether system allows the user to Convert the image psd file differenet formats like png, tiff, gif, jpeg");
