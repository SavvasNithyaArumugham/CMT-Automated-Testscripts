...
public class AUT_AG_015P1 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AUT_AG_015P1() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify new version of optimized file is auto-created in Optimized folder upon demoting the lifecycle state to Optimize for JPG from Optimization completed");
