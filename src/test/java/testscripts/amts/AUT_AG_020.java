...
public class AUT_AG_020 extends TestCase {
	...
	@Test
	public void AUT_AG_020() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify the presence of lifecycle name-Image Optimization upon clicking Attach lifecycle for normal folder from More option or file preview page or selected items of My files");
