...
public class AUT_AG_782 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AMTS_007() {
		testParameters
				.setCurrentTestDescription("To Verify whether system allow the user to set resize rules by entering absolute size values.");
	...
	public void executeTest() {
		...
		if (mediaTransPage.clickOnAddTransformationRulesBtn()) {
			...
			mediaTransPage.addImgResizeBySize(height,width);
