...
public class AUT_AG_083 extends TestCase {
	...
	public void AMTS_043() {
		testParameters
				.setCurrentTestDescription("Verify the user is navigated to the repositary after clicking on cancel button in the Media transformation Profile page");
	...
	public void executeTest() {
		...
		mediaTransPage.clickOnCancelBtn();
	}
