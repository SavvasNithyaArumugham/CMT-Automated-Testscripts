...
public class AUT_AG_106 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify the user is not able to enter alphabets in by absolute size in the resize pane");
	...
	//	docLibPge.deleteAllFilesAndFolders();
		...
		if (mediaTransPage.clickOnAddImageProfBtn()) {
			...
			mediaTransPage.enterAlphabetsInAbsoluteSize("asd");
		}
