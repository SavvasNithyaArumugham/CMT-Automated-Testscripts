...
public class AUT_AG_140 extends TestCase {
	...
	public void AMTS_068() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line not enabled with other effect profile on source image not having caption value");
