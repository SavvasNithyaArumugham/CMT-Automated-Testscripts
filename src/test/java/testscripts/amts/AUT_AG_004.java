...
public class AUT_AG_004 extends TestCase{
	...
	@Test
	public void AMTS_081()
	{
		testParameters.setCurrentTestDescription("Verify that macro code is replaced with subasset code in transformed file when filename based transformation is done for source video file(filename_macrocode_subassetcode_)");
