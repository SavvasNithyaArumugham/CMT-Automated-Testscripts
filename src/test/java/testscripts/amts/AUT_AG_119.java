...
public class AUT_AG_119 extends TestCase{
	...
	@Test
	public void runTCAUT_AG_119()
	{
		testParameters.setCurrentTestDescription("Verify whether the user is able to apply the low rendition profile for any file format");
