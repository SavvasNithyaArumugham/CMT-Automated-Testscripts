...
public class AUT_AG_104 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify the user gets a message when both the check box are enabled in the resize pane");
	...
	public void executeTest() {
		...
		if (mediaTransPage.clickOnAddImageProfBtn()) {
			...
			mediaTransPage.checkForMsgInResizePane();
		}
	}
