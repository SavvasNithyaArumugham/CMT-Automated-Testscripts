...
public class AUT_AG_012 extends TestCase {
	...
	public void executeTest() {
		...
		String editoffopt = dataTable.getData("MyFiles", "BrowseActionName");
	...
	//	mediaTransPage.applyTransformationByFileBased(reName, preTxt);
		...
		String finalFileName = fileName.replace(".gif","_"+subAsstCode+"."+imageType);
		...
		docLibPg.commonMethodForClickOnMoreSettingsOption(finalFileName, editoffopt);
		
		sitesPage.verifyLockedBanner(finalFileName);	
