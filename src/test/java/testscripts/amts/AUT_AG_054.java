...
public class AUT_AG_054 extends TestCase {
	...
	public void AMTS_074() {
		testParameters
				.setCurrentTestDescription("Verify the user is able to navigate to the document library after applying the profile with file based and target folder with watch folder icon displayed");
	...
	//	String[] file = fileNme.split(Pattern.quote("."));
		...
		if (mediaTransPage.isTransferredFileIsAvailable(fileNme)) {
			...
			report.updateTestLog(
					"Verify Video profile applied Successfully to the File "
							+ fileNme, "Video profile is not applied."
