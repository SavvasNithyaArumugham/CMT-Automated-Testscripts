...
public class AUT_AG_002 extends TestCase {
	...
	@Test
	public void AMTS_079() {
		testParameters
				.setCurrentTestDescription("Verify user is able to created image profile with sub asset code containing dash in the middle and verify its transformed file by applying the profile");
	...
	public void executeTest() {
		...
		mediaTransPage.commonMethodForEnterImageProfDetails(profName, profDesc,
				macCode, "-------", filePathForUploadFile, fileNameForUpload);
		...
		for (String filename : fileNames) {
			...
			String fileName = file[0] + "_" + "-------" + "-" + preTxt + "."
					+ imageType;
