...
public class AUT_AG_142 extends TestCase {
	...
	@Test
	public void AMTS_070() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line not enabled without other effect profile on source image not having caption field");
