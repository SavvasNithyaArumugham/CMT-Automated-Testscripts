...
public class AUT_AG_059 extends TestCase {
	...
	@Test
	public void runTCAUT_AG_059() {
		testParameters
				.setCurrentTestDescription("Verify that 'Request placed in queue' message is displayed after applying the transformation for a profile and transform svg to gif");
