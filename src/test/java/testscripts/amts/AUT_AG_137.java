...
public class AUT_AG_137 extends TestCase {
	...
	public void AMTS_065() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line enabled without other effect profile on source image not having caption field");
