...
public class AUT_AG_134 extends TestCase {
	...
	public void AMTS_062() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line enabled with other effect profile on source image not having caption field");
	...
	public void executeTest() {
		...
		if (mediaTransPage.clickOnAddImageProfBtn()) {
			...
			mediaTransPage.addColorModeForImg(colorModeOption);
