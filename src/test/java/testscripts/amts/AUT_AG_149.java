...
public class AUT_AG_149 extends TestCase {
	...
	public void AMTS_077() {
		testParameters
				.setCurrentTestDescription("Verify the user is able to apply rendition profile to folder containing TIF image and 3 level of subfolders");
	...
	public void executeTest() {
		...
		myFiles.openCreatedFolder(folderName+"11");
