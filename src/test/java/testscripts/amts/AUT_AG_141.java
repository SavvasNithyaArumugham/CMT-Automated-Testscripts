...
public class AUT_AG_141 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AMTS_069() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line not enabled without other effect profile on source image having caption value");
