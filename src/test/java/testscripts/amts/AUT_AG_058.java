...
public class AUT_AG_058 extends TestCase {
	...
	@Test
	public void runTCAUT_AG_058() {
		testParameters
				.setCurrentTestDescription("Verify that 'Request placed in queue' message is displayed after applying the transformation for a profile and transform svg to jpg");
