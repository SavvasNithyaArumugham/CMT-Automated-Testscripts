...
public class AUT_AG_003 extends TestCase{
	...
	{
		testParameters.setCurrentTestDescription("Verify that macro code is replaced with subasset code in transformed file when filename based transformation is done for source image file(filename_macrocode_)");
	...
	public void executeTest() {
		...
		System.out.println("Replaced file name" +reName );
		...
		UIHelper.waitFor(driver);
	//	String finalFileName = fileName.replace(".gif", "_"+subAsstCode+"_-"+preTxt+"."+imageType);
