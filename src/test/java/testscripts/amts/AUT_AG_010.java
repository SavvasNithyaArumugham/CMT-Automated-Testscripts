...
public class AUT_AG_010 extends TestCase {
	...
	@Test
	public void AMTS_087() {
		testParameters
				.setCurrentTestDescription("Verify user is able to created image profile with sub asset code containing multiple dashes in the starting and verify its transformed file by applying the profile <br>"+
		"ALFDEPLOY-4427_Verify the target output filename does not cut off period present in source file when image transformation is applied for file containining period");
