...
public class AUT_AG_802 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AMTS_017() {
		testParameters
				.setCurrentTestDescription("To Verify whether the user is able to select a Transformation profile from the list of available and apply to a folder.");
