...
public class AUT_AG_018 extends TestCase {
	...
	@Test
	public void AUT_AG_018() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify optimized file is created in Optimized folder upon promoting the lifecycle state of an image to Optimize for PNG from Ready for Optimization");
