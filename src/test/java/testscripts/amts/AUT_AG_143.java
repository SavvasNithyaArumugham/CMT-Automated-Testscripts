...
public class AUT_AG_143 extends TestCase {
	...
	public void AMTS_071() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line not enabled without other effect profile on source image not having caption value");
