...
public class AUT_AG_135 extends TestCase {
	...
	@Test
	public void AMTS_063() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line enabled with other effect profile on source image not having caption value");
