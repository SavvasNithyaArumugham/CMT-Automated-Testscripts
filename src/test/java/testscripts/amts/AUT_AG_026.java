...
public class AUT_AG_026 extends TestCase {
	...
	@Test
	public void AUT_AG_026() {
		
		testParameters
		.setCurrentTestDescription("ALFDEPLOY-5071_Verify the presence of lifecycle name-Image Optimization upon clicking Attach lifecycle for image file which is present outside the rule applied folder from More option or file preview page or selected items of Shared files");
