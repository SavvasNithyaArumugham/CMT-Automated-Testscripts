...
public class AUT_AG_097 extends TestCase {
	...
	@Test
	public void AMTS_053() {
		testParameters
				.setCurrentTestDescription("Verify the user is able to remove the added values from the create transformation profile page");
	...
	public void executeTest() {
		...
		String transformationProfWizardValues = dataTable.getData("Media_Transform", "TransformationProfWizardValues");
		...
		if (mediaTransPage.clickOnAddTransformationRulesBtn()) {
			...
			mediaTransPageTest.addAndRemoveTransformationProfilePageDataForImage(transformationProfWizardValues);
