...
public class AUT_AG_133 extends TestCase {
	...
	@Test
	public void AMTS_061() {
		testParameters
				.setCurrentTestDescription("To verify the user is able to apply credit line enabled with other effect profile on source image having caption value");
