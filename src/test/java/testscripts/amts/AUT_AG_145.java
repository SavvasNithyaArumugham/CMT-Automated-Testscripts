...
public class AUT_AG_145 extends TestCase {
	...
	public void AMTS_073() {
		testParameters
				.setCurrentTestDescription("Validate the selection of target folder via relative path for video file transformation"
						+"ALFDEPLOY-4427_Verify rendition occurs successfully when rendition is applied to image file containing periods");
	...
	public void executeTest() {
		...
		myFiles.openCreatedFolder(parentFolderName);
		myFiles.openUploadedOrCreatedFile(fileNme1, "");
		...
		adminPg.navigateToNodeBrowserDetailsPg(fileNme1);
