...
public class AUT_AG_131 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AMTS_059() {
		testParameters
				.setCurrentTestDescription("To verify the  user is able to apply credit line not enabled with other effect profile on source image not having caption field");
	...
	public void executeTest() {
		...
		String propertyValues = dataTable.getData("Document_Details", "ExpectedFieldValues");
		docDetailsPageTestObj.verifyAttributesInPropertySecForNegativeCase(propertyValues);
