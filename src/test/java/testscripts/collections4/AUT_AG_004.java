...
public class AUT_AG_004 extends TestCase {
	...
	public void COLLECTIONS_043() {
		testParameters
				.setCurrentTestDescription("TC_ALFDEPLOY-3309_To verify user able to add thumbnail if Site display name "
						+ "is given in thumbnail field where user is member of the Moderated site(Site name:File name)"
