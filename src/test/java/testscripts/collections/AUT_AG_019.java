...
public class AUT_AG_019 extends TestCase {
	...
	@Test
	public void COLLECTIONS_058() {
		testParameters
				.setCurrentTestDescription("ALFDEPLOY-4050_06_Verify Filter command is displayed above the collection tree for Asset object type on editing collection.");
	...
	public void executeTest() {
		...
		// Go to collection UI
	     ...
	     // create collections objects
				...
				UIHelper.waitForAnElement(driver,UIHelper.findAnElementbyXpath(driver, "//button[contains(@id,'filter-results-button')]"));
				UIHelper.scrollToAnElement(UIHelper.findAnElementbyXpath(driver, "//*[@class='filename']//*[contains(text(),'AutoAsset')]"));
				
		 // Object creation for Asset
			...
			listOfObjects=collectionPg.getFoldersFromRightPanInCollectionUi();		
				...
				if(listOfObjectsString.contains("AutoAsset"))  
								
				  {
			
					collectionPg.openCollectionObject("AutoAsset");
