...
public class ALFDEPLOY_2236_TC004 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void COLLECTIONS_010() {
		testParameters.setCurrentTestDescription("Following the creation of a content object can see that the External ID metadata is populated with a value starting with an 'L' followed by one or more digits");
	...
	public void executeTest() {
		...
		collectionPg.enterBasicDataForContentObject(
				...
				collectionObjectDataArray[6], collectionObjectDataArray[7],collectionObjectDataArray[8],collectionObjectDataArray[9],collectionObjectDataArray[10],collectionObjectDataArray[11],collectionObjectDataArray[12],collectionObjectDataArray[13]);
