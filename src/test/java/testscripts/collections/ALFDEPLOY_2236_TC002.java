...
public class ALFDEPLOY_2236_TC002 extends TestCase {
	...
	public void COLLECTIONS_008() {
		testParameters.setCurrentTestDescription(
				"1. Following the creation of a course object can see that the External ID metadata is populated with a value starting with an 'L' followed by one or more digits");
	...
	public void executeTest() {
		...
		collectionPg.enterBasicDataForCreateCourseObject(collectionObjectDataArray[0], collectionObjectDataArray[1],
				collectionObjectDataArray[2], collectionObjectDataArray[3], collectionObjectDataArray[4],collectionObjectDataArray[5],collectionObjectDataArray[6],collectionObjectDataArray[7]);
