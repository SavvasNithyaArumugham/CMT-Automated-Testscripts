...
public class AUT_AG_023 extends TestCase {
	...
	public void COLLECTIONS_040() {
		testParameters
				.setCurrentTestDescription("1. ALFDEPLOY-4417_Verify the URL remains in the generated relize CSV for Composite object after the Metadata gets updated for linked asset when it is Indirect child to Course.");
