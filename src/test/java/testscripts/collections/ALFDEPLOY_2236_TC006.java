...
public class ALFDEPLOY_2236_TC006 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void COLLECTIONS_012() {
		testParameters.setCurrentTestDescription("Following the creation of a container can see that the External ID metadata is populated with a value starting with an 'L' followed by one or more digits");
	...
	public void executeTest() {
		...
		collectionPg.enterBasicDataForContainer(collectionObjectDataArray[0], 
				collectionObjectDataArray[1], collectionObjectDataArray[2], collectionObjectDataArray[3], collectionObjectDataArray[4]);
