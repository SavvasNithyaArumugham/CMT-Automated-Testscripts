...
public class ALFDEPLOY_2836_TC005 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void COLLECTIONS_081() {
		testParameters
	...
	public void executeTest() {
		...
		// Navigate to the source object's (A) details page.

		// Navigate to the new object's (B) details page.
