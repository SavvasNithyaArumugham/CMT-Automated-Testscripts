...
public class ALFDEPLOY_2431_TC001 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void COLLECTIONS_050() {
		testParameters
				.setCurrentTestDescription("When generating a course CSV containing any objects where the File Type = 'Test' and the 'Test Type' is blank, can see the following error is reported: 'Test Type' must not be BLANK");
