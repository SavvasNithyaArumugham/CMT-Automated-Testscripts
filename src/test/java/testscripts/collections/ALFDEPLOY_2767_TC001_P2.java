...
public class ALFDEPLOY_2767_TC001_P2 extends TestCase {
	...
	@Test
	public void COLLECTIONS_031() {
		testParameters
				.setCurrentTestDescription("Within the collection UI, can see a 'duplicate all/duplicate all to/duplicate object' action on any Course, Sequence Object, Container, Learning Bundle, Composite Object and Content Object");
	...
	public void executeTest() {
		...
		// verify Was originally duplicated from and Was duplicated from for
		// originalObjectList is not populated
...
//		verify Was duplicated from, Has duplicates, Was originally duplicated from duplicated object via "duplicate all"
		for (String string : duplicateAllObjectList_A_B) {
...
//		verify Was duplicated from, Has duplicates, Was originally duplicated from duplicated object via "duplicate all to"
