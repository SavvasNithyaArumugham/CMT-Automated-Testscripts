...
public class AUT_AG_020P3 extends TestCase {
	...
	public void sharebox_020() {
		testParameters
				.setCurrentTestDescription("Verify the Manager is able to share others folders externally through the 'Share Folder Externally' option - Open site and Share others Folder Externally");
