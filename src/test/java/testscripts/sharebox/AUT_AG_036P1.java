...
public class AUT_AG_036P1 extends TestCase
{
	...
	@Test
	public void sharebox_035()
	{
		testParameters.setCurrentTestDescription("Verify the 'A file already exists with the same name' error message once the file is upload successfully - Part1: Share a folder using sharebox option");
