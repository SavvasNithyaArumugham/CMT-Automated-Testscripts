 ...
 *
 */
public class AUT_AG_052P1 extends TestCase {

	@Test
	public void sharebox_015() {
		testParameters
				.setCurrentTestDescription("ALFDEPLOY-3638_Verify user can download a root folder contains 3 level subfolder and each folders has some files in it-Part 2:Verify the external user mailbox");
