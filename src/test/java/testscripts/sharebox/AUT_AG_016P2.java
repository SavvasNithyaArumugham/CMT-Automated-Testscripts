...
public class AUT_AG_016P2 extends TestCase
{
	...
	@Test
	public void sharebox_016()
	{
		testParameters.setCurrentTestDescription("Verify the Coordinator is able to share others folders externally through the 'Share Folder Externally' option - Accept Site as Coordinator and Share others Folder Externally");
