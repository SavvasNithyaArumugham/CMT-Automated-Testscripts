...
public class AUT_AG_030P1 extends TestCase {
	...
	@Test
	public void runAUT_AG_181P1() {
		testParameters
				.setCurrentTestDescription("verify whether external user is able to view 'File uplaod failed' error message when an uplaod fails via ShareBox -Part1 : Share a folder externally");
