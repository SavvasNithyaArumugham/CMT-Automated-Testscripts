...
public class AUT_AG_050P1 extends TestCase {
	...
	public void sharebox_015() {
		testParameters
				.setCurrentTestDescription("ALFDEPLOY-3638_Verify user can download a root folder contains subfolder and has some files in it-Part 2:Verify the external user mailbox");
