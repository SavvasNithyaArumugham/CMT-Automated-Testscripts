...
public class AUT_AG_035P1 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the external user is able to cancel the upload of the new file into the Shared folder by clicking on the 'Abort' button - Part1: Share a folder using sharebox option");
