...
public class AUT_AG_018P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the Collaborator is able to share others folders externally through the 'Share Folder Externally' option - Accept Site as Collaborator and Share others Folder Externally");
