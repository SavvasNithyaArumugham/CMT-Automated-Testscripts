...
public class AUT_AG_018P3 extends TestCase {
	...
	public void sharebox_018() {
		testParameters
				.setCurrentTestDescription("Verify the Collaborator is able to share others folders externally through the 'Share Folder Externally' option - Verify the external user mailbox");
