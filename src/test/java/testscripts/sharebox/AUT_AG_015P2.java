...
public class AUT_AG_015P2 extends TestCase
{
	...
	{
		testParameters.setCurrentTestDescription("Verify the Coordinator is able to share own folders externally through the 'Share Folder Externally' option - Accept Site as Coordinator and Share own Folder Externally");
