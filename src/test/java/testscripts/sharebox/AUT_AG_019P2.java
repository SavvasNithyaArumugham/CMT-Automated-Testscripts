...
public class AUT_AG_019P2 extends TestCase {
	...
	public void sharebox_019() {
		testParameters
				.setCurrentTestDescription("Verify the Manager is able to share own folders externally through the 'Share Folder Externally' option - Verify the external user mailbox");
