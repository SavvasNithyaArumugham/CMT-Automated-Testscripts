...
public class AUT_AG_021P1 extends TestCase {
	...
	public void sharebox_021() {
		testParameters
				.setCurrentTestDescription("Verify user is not getting any email notification, when the “Notify Sharer” and “Notify Shared with” checkboxes are unchecked in the Sharebox folder window - Part1: Share a folder using sharebox option");
