...
public class AUT_AG_017P2 extends TestCase
{
	...
	@Test
	public void sharebox_017()
	{
		testParameters.setCurrentTestDescription("Verify the Collaborator is able to share own folders externally through the 'Share Folder Externally' option - Accept Site as Collaborator and Share own Folder Externally");
