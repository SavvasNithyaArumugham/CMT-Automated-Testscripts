...
public class AUT_AG_003P1 extends TestCase {
	...
	public void sharebox_003() {
		testParameters
				.setCurrentTestDescription("Verify the user receives the activity email immediately, if the internal user uploads a file into the Shared Folder and the Notifications is set as 'immediately'");
