...
public class AUT_AG_017P3 extends TestCase {
	...
	public void sharebox_017() {
		testParameters
				.setCurrentTestDescription("Verify the Collaborator is able to share own folders externally through the 'Share Folder Externally' option - Verify the external user mailbox");
