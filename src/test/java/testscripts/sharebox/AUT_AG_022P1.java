...
public class AUT_AG_022P1 extends TestCase {
	...
	public void sharebox_022() {
		testParameters
				.setCurrentTestDescription("Verify the external user is not able to upload 0 byte/empty file into the Shared Folder - Part1: Share a folder using sharebox option");
