...
public class AUT_AG_139 extends TestCase
{
	...
	@Test
	public void search_138()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform Aspect search for aspect ' Pearson Custom Lifecycle Aspect' after selecting 'State' from the drop down and giving state name (having space in the starting and at the end of the name) in Value Tab.");
