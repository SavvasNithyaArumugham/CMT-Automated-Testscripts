...
public class AUT_AG_138 extends TestCase
{
	...
	@Test
	public void search_137()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform Aspect search for aspect ' Pearson Custom Lifecycle Aspect ' after selecting 'State' from the drop down and giving state name (having space in it) in Value Tab");
