...
public class AUT_AG_115 extends TestCase {
	...
	@Test
	public void search_114() {
		testParameters
				.setCurrentTestDescription("Verify that the user is able to modify the existing  Saved Searches Query and run it and saved it again with different name");
