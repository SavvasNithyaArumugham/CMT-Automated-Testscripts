 ...
 * @author Moshin
 */
public class AUT_AG_170P5 extends TestCase {
	...
	public void search_119() {
		testParameters
				.setCurrentTestDescription(
						"ALFDEPLOY-2347_To verify , Consumer can perform actions using document/folder actions under Selected Item as per his role, +"
						+ "when performs search for folder via Baisc/Advance search"
						+"ALFDEPLOY-2347_To verify , Consumer can perform actions using document/folder actions under Selected Item as per his role, "
						+ "when performs search for file via Baisc/Advance search"	);
