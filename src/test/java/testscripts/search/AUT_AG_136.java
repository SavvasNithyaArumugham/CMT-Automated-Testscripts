...
public class AUT_AG_136 extends TestCase
{
	...
	@Test
	public void search_135()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform Advance Search for aspect ' Pearson Custom Lifecycle Aspect' by selecting 'Lifecycle Name' and giving full text Lifecycle name having space in it in Value tab. eg : Print UK Schools");
