...
public class AUT_AG_082 extends TestCase
{
	...
	@Test
	public void search_081()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform search by using multiple aspects.");
	...
	public void executeTest()
	{
		...
		appSearchPgTest.verifyMultiAspectSearchResults();
