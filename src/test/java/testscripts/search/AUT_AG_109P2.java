 ...
 * @author Moshin
 */
public class AUT_AG_109P2 extends TestCase {
	...
	public void search_108() {
		testParameters
				.setCurrentTestDescription("Verify that  all users is able to run Saved Searches queries created by another user with Public visiblity- Run Saved search");
