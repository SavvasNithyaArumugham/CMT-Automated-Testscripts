...
public class AUT_AG_147 extends TestCase {
	...
	@Test
	public void search_146() {
		testParameters
				.setCurrentTestDescription("Verify that 'Saved Search' dashlet is not available under Add Dashlet for Admin user on customise site dashlet page");
