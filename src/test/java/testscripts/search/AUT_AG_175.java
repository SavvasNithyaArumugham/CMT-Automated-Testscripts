...
public class AUT_AG_175 extends TestCase {
	...
	public void search_109() {
		testParameters
				.setCurrentTestDescription("Verify whether user is able to perform Private Saved Search from homepage search dashlet when private search is saved with alphanumeric"
		);
