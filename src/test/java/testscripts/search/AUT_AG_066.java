 ...
 * @author Cognizant
 */
public class AUT_AG_066 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void search_065()
	{
		testParameters.setCurrentTestDescription("Verify that user able to perform Search with Special Characters");
