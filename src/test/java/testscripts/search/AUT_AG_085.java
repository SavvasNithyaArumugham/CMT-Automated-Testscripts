...
public class AUT_AG_085 extends TestCase
{
	...
	@Test
	public void search_084()
	{
		testParameters.setCurrentTestDescription("Verify that Special characters are allowed in the Value field of aspect search but the value should start with either alphabate or number");
	...
	public void executeTest()
	{
		...
		appSearchPgTest.verifyAspectResults();
