...
public class AUT_AG_095 extends TestCase
{
	...
	@Test
	public void search_094()
	{
		testParameters.setCurrentTestDescription("Verify the user is not  able to perform Advance Search  when he gave UserName in the lowercase of the  in  Modifier field");
