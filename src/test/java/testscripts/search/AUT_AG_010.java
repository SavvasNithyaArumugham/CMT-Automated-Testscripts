...
public class AUT_AG_010 extends TestCase
{
	...
	@Test
	public void search_009()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform search on "
				+ "any aspect which is associated with a file or folder");
