...
public class AUT_AG_102 extends TestCase {
	...
	@Test
	public void search_101() {
		testParameters
				.setCurrentTestDescription("Verify that  fields available for save Search on the Search Result Page");
	...
	public void executeTest() {
		...
		appSearchPgTest.verifySavedSearchElements();
