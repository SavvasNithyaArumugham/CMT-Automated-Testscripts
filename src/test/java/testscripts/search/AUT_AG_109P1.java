 ...
 * @author Moshin
 */
public class AUT_AG_109P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void search_108() {
		testParameters
				.setCurrentTestDescription("Verify that  all users is able to run Saved Searches queries created by another user with Public visiblity- Saved search with public visibility");
