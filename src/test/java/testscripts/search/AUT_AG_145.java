...
public class AUT_AG_145 extends TestCase {
	...
	@Test
	public void search_144() {
		testParameters
				.setCurrentTestDescription("Verify that 'Saved Search' dashlet is not available under Add Dashlet for Admin user on customise user dashlet page.");
