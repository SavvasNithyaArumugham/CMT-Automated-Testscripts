...
public class AUT_AG_132 extends TestCase
{
	...
	@Test
	public void search_131()
	{
		testParameters.setCurrentTestDescription("Verify that user is able to perform advance search using space in values of Aspect search.(Without quotation marks or underline around the search terms)");
