...
public class AUT_AG_094 extends TestCase
{
	...
	@Test
	public void search_093()
	{
		testParameters.setCurrentTestDescription("Verify the user is able to perform Advance Search by "
				+ "providing Last Name, First Name. of the User in  Modifier field");
