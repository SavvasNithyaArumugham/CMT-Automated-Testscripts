...
public class ALFDEPLOY_2755_TC001 extends TestCase {
	...
	@Test
	public void runALFDEPLOY_2755_TC001() {
		testParameters
	...
	public void executeTest() {
		...
		String DescriptorIDFromCsv = "bb155ef5-29ab-4946-bc52-497e0cfe4119";
		if (DescriptorID.equalsIgnoreCase(DescriptorIDFromCsv)) {
		...
		String externalIdAfterEdit = collectionPg
				.verifyObjectDetailsInViewdatailsPage(
