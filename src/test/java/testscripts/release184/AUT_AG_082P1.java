 ...
 * @author Cognizant
 */
public class AUT_AG_082P1 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void runAUT_AG_082P1()
	{
		testParameters.setCurrentTestDescription("Verify the Uploaded by column details in External Sharebox on uploading files below 100MB via External Users - Part1: Share a folder using sharebox option");
