...
private FunctionalLibrary functionalLibrary;
	...
	@Test
	public void unzip_13()
	{
		testParameters.setCurrentTestDescription("Verify user can Unzip a folder from Shared Files with the other site selecting Unzip to option under document actions");
