...
public class AUT_AG_425 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void calculateSizeFromSearch1()
	{
		testParameters.setCurrentTestDescription("1.ALFDEPLOY-4903_Verify Calculate size using selected item drop down for a folder in search results page.");
	...
	public void executeTest()
	{
		...
		searchPg.commonMethodForPerformSelectedItemsOperation(folderName, selectedItemsOptionName);
