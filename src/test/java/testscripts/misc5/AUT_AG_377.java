 ...
 * @author Cognizant
 */
public class AUT_AG_377 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void runTC128() {
		testParameters
				.setCurrentTestDescription("Verify we start workflow from My files.");
	...
	public void executeTest() {
		...
		AlfrescoHomePage hmepg = new AlfrescoHomePage(scriptHelper);
		hmepg.navigateToMyFilesTab();
