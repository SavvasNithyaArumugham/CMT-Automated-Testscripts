 ...
 * @author Cognizant
 */
public class AUT_AG_386 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void runTC128() {
		testParameters
				.setCurrentTestDescription("Verify Content fulfilment workflow is get created for ISBN 10 digit"
						+ "Verify Content fulfilment workflow fields get populated automatically");
