 ...
 * @author Cognizant
 */
public class AUT_AG_384P1 extends TestCase {
	...
	public void runTC128() {
		testParameters
				.setCurrentTestDescription("Verify Content fulfilment workflow Can be create by Consumer"
						+ "Verify Content fulfilment workflow Can be create by Coordinator - Create Site , Add user");
	...
	public void executeTest() {
		...
		String siteuserName1 = dataTable.getData("Sites", "SiteToSelect");
		String roleName1 = dataTable.getData("Sites", "TargetSiteName");
/*		sitesPage.performInviteUserToSite(siteName);*/

		siteMemPgTest.verifySiteMemebrs(siteName, siteuserName1, roleName1);
