 ...
 * @author Cognizant
 */
public class AUT_AG_420P2 extends TestCase {

	@Test
	public void sharebox_414P2() {
		testParameters
				.setCurrentTestDescription("ALFDEPLOY-3490_Verify user can view the Downloaded Zip package via External sharebox when the "
						+ "action is performed from sub folder level when the RF contains 7 level deep folders and 6 files "
						+ "in each subfolders - Part 2");
	...
	public void executeTest() {
		...
		shareboxPg.performDownloadZipInShareboxPage(downloadZipFileName, fileDownloadPath);
