 ...
 * @author Cognizant
 */
public class AUT_AG_400P3 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void MISC2_037() {
		testParameters.setCurrentTestDescription(
				"Verify Manager or Coordinator or Collaborator or Contributor can delete own folder containing somebody elses content");
