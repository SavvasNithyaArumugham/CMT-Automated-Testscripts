 ...
 * @author Cognizant
 */
public class AUT_AG_403P2 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void MISC5_03736P2() {
		testParameters.setCurrentTestDescription(
				"ALFDEPLOY-3736_Verify Delete button is not visible to user (Manager/Contributor/Co-ordinator/Collaborator/Consumer"
				+ "/Reviewer) who is not in Site Delete group and is a member of site abc when searched site via site finder.");
