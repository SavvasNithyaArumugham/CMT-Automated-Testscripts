...
public class AUT_AG_424 extends TestCase
{
	private FunctionalLibrary functionalLibrary;
	
	@Test
	public void calculateSizeUsingSelectedItemDropDown2()
	{
		testParameters.setCurrentTestDescription("1.ALFDEPLOY-4902_02_Verify Calculate size using selected item drop down for a file and folder together in document library page");
