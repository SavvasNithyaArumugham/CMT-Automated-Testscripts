 ...
 * @author Cognizant
 */
public class AUT_AG_420P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void sharebox_414P1() {
		testParameters.setCurrentTestDescription(
				"ALFDEPLOY-3490_Verify user can view the Downloaded Zip package via External sharebox when the "
				+ "action is performed from sub folder level when the RF contains 7 level deep folders and 6 files "
				+ "in each subfolders - Part 1");
