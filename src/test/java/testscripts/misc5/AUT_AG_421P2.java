 ...
 * @author Cognizant
 */
public class AUT_AG_421P2 extends TestCase {

	@Test
	public void sharebox_415P2() {
		testParameters.setCurrentTestDescription("ALFDEPLOY-3490_Verify user can view the Downloaded Zip package "
				+ "via External sharebox from 5th subfolder level when the RF contains 10 level deep folders "
