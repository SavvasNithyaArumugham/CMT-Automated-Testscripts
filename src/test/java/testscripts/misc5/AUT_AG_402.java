 ...
 * @author Cognizant
 */
public class AUT_AG_402 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void MISC2_037() {
		testParameters.setCurrentTestDescription(
				"Verify tooltip information is displayed correctly instead of javascript label on hovering all the sub menus present under Sites,Tasks and User Menu for Non-Admin Users.");
