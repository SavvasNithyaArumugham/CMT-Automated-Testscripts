 ...
 * @author Cognizant
 */
public class AUT_AG_410P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void navigateSevenFoldersSharebox() {
		testParameters.setCurrentTestDescription(
				"ALFDEPLOY-3498_Verify user can navigtae to 7th folder inside a subfolder via External sharebox");
