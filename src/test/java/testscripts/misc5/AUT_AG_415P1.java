 ...
 * @author Cognizant
 */
public class AUT_AG_415P1 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void navigateBackFromFourDeepFolderSharebox1() {
		testParameters.setCurrentTestDescription(
				"ALFDEPLOY-3526_Verify the externanl ShareBox navigation after external user uploads "
				+ "file inside the 4 level subfolder - Part1 )");
