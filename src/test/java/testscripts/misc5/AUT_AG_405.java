 ...
 * @author Cognizant
 */
public class AUT_AG_405 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void copyToScreenCheckDocLib1() {
		testParameters.setCurrentTestDescription(
				"ALFDEPLOY-3980_Verify user should not see create link option in copy to screen for any"
				+ " folders or files in document library");
	...
	public void executeTest() {
		...
		docLibPage.commonMethodForClickOnMoreSettingsOption(fileName ,moreSettingOption );
