...
public class MG_TC005P2 extends TestCase {
	...
	public void AVT_015() {
		testParameters.setCurrentTestDescription(
				"Verify the user is switched to the Streaming Video tab of the Media Guide Interface on selecting untranscoded video files and on click of Convert Streaming Media button.<br>");
