...
public class AUT_AG_048P4 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription("Verify Contributor is able to edit all the fields of Metrodigi smart link through Edit Smart link option created by self");
