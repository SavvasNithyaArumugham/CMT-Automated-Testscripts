...
public class AUT_AG_024P6 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				+ "for Metrodigi link through Edit smartlink"
				+"ALFDEPLOY-4130_Verify Select File Button is displayed under Metrodigi link to choose existing files "
				+ "from alfresco in Edit smartlink Screen."
				+"ALFDEPLOY-4129_Verify Select File Button is displayed under Metrodigi link to choose from existing "
				+ "files in Create smartlink Screen."
				+"ALFDEPLOY-4224_Verify on click of Edit smartlink for Metrodigi object, the Edit smartlink form "
				+ "should be expanded."
				+"ALFDEPLOY-4131_Verify user is able to clear the uploaded file and its path under Metrodigi Link through"
				+ " Edit Smart Link option."
				+"ALFDEPLOY-4131_Verify user is able to clear the selected file and its path under Metrodigi Link through"
				+ " Edit Smart Link option."
				+"ALFDEPLOY-4116_To verify user is getting edit Smartlink option via More for metrodigi form type smart link object"
	...
	//	UIHelper.waitForLong(driver);
		...
		// Select: in creation and edit Smartlinks:
		...
		collectionPg.clickOnMoreSetting(title);
		boolean flag = collectionPg.CheckOptionsForClickOnMoreSettingsOption(title,"Edit SmartLink");
		if(flag){
			report.updateTestLog("Edit Smartlink:", "Edit Smartlink is presented for "+"<b>"+title, Status.PASS);			
		}else{
			report.updateTestLog("Edit Smartlink:", "Edit Smartlink is not presented for "+"<b>"+title, Status.FAIL);			
		...
		//UIHelper.waitForPageToLoad(driver);
			...
			e.printStackTrace();
			report.updateTestLog("AUT_AG_024P6 status:", "<br>AUT_AG_024P6 Testcase is Failed", Status.FAIL);							
