...
public class AUT_AG_027P1 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		...
		"ALFDEPLOY-4118_Verify the Minor version increment on editing any fields available for Image "
		+ "external links via Edit smart link screen"
		+"ALFDEPLOY-4118_Verify the version should not get incremented for image external links "
		+ "when saving the details via Edit smart link screen without editing any field values."
		+"ALFDEPLOY-4223_Verify title and url of Image smart link object is editable and there "
		+ "should be minor increment in version once changes are done."
		+"ALFDEPLOY-4119_Verify there should be increment version when there is a change in"
		+ " URL for smart link -Image"
		+"ALFDEPLOY-4119_Verify there should be increment version when there is a change in Title "
		+ "for smart link - Image"
		+"ALFDEPLOY-4119_Verify there should be increment version when there is a change in URL and "
		+ "title for smart link - Image."
				);
	...
	//	UIHelper.waitForLong(driver);
		avsmart.VersionCheckdocument("1.1", "Changed");
			...
			report.updateTestLog("AUT_AG_027P1 status:", "<br>AUT_AG_027P1 Testcase is Failed", Status.FAIL);							
