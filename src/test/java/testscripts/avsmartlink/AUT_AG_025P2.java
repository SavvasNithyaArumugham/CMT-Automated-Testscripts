...
public class AUT_AG_025P2 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		testParameters.setCurrentTestDescription(
				...
				" <br>ALFDEPLOY-4123_To verify Edit smartlink  option is getting display for smartlink- audio files."			
				+"<br>ALFDEPLOY-4123_To verify Edit smartlink  option is not getting display for files other than "
				+ "smartlink file."
				+"<br>ALFDEPLOY-4123_To verify user is able to submit successfully after making changes in smartlink "
				+ "properties and the version of the smartlink changes after every edit in Edit of smartlink-audio."
				+"<br>ALFDEPLOY-4123_To verify on clicking Cancel button , changes made by the user will revert back to "
				+ "original state in Edit smartlink-audio file."
				+"ALFDEPLOY-4116_To verify user is getting edit Smartlink option via More for Audio type smart link object."
				+"ALFDEPLOY-4117_To verify for Audio smart link object on clicking Edit Smart link via More option ,"
				+ " user is getting only Audio form pop up displaying exsisting field values."
