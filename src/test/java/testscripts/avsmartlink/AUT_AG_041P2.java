...
public class AUT_AG_041P2 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				"1.ALFDEPLOY-4127_Verify Co-ordinator/Collaborator/Contributor is getting Edit smartlink option"+
				" displayed for External Web site smartlink object which is created by manager and collaborator co-ordinator are able to edit"
