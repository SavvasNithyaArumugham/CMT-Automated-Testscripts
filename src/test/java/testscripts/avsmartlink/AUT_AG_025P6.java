...
public class AUT_AG_025P6 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		testParameters.setCurrentTestDescription(
				...
				" <br>ALFDEPLOY-4121_To verify Edit smartlink  option is getting display for smartlink- VIDEO FILE."			
				+"<br>ALFDEPLOY-4121_To verify Edit smartlink  option is not getting display for files other than "
				+ "smartlink file."
				+"<br>ALFDEPLOY-4121_To verify user is able to submit successfully after making changes in smartlink "
				+ "properties and the version of the smartlink changes after every edit in Edit of smartlink-VIDEO."
				+"<br>ALFDEPLOY-4121_To verify on clicking Cancel button , changes made by the user will revert back to "
				+ "original state in Edit smartlink-VIDEO file."
				+"ALFDEPLOY-4116_To verify user is getting edit Smartlink option via More for Video type smart link object"
				+"ALFDEPLOY-4117_To verify for Video smart link object on clicking Edit Smart link via More option ,"
				+ " user is getting only Video form pop up displaying exsisting field values."
				);
	...
	//	UIHelper.waitForPageToLoad(driver);
		...
		if(flag1){
			...
			report.updateTestLog("AUT_AG_025P6 status:", "<br>AUT_AG_025P6 Testcase is Failed", Status.FAIL);							
