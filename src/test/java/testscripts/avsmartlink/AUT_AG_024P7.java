...
public class AUT_AG_024P7 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				+ " for Table link through Edit smartlink"
				+"ALFDEPLOY-4130_Verify Select File Button is displayed under Table link to choose existing files from "
				+ "alfresco in Edit smartlink Screen."
				+"ALFDEPLOY-4129_Verify Select File Button is displayed under Table link to choose from existing files "
				+ "in Create smartlink Screen."
				+"ALFDEPLOY-4224_Verify on click of Edit smartlink for Table object, the Edit smartlink form should be "
				+ "expanded."
				+"ALFDEPLOY-4131_Verify user is able to clear the uploaded file and its path under Table Link through Edit"
				+ " Smart Link option."
				+"ALFDEPLOY-4131_Verify user is able to clear the selected file and its path under Table Link through Edit "
				+ "Smart Link option."
	...
	public void executeTest() {
		...
		//avsmart.entersmarttypedata(link, title, extURLLink, "Image", "Caption", "credit","", title);
