...
public class AUT_AG_38P2 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AV_002() {
		testParameters.setCurrentTestDescription("1.ALFDEPLOY-3873_Verify the creation of 3rd party interactive link with 3PI vendor(Social Explorer) and Optimized for use on mobile radio button options filled"
 ...
 /* Site finder
   ...
   */
	 ...
	 // Navigate to Smart link Page
	 	...
	 	WebElement w2=driver.findElement(By.xpath(PI1));
	 	//w2.click();
	 	Select s1= new Select(w2);
	 	s1.selectByVisibleText("Social Explorer");
	 	...
	 	WebElement w3=	driver.findElement(By.xpath(Optimized1));
	...
	report.updateTestLog("Check whether 3rd party interactive link with 3PI vendor(Social Explorer) and Optimized for use on mobile is created" , "Status: "  +"3rd Party Interactive smartlink is created", Status.PASS);
