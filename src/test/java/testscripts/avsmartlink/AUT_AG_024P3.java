...
public class AUT_AG_024P3 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				+ "button for Audio External link through Edit smartlink."
				+"<br>ALFDEPLOY-4134_Verify the UI path on uploading a new file under Image Preview - Upload file button for"
				+ " Audio External link through Edit smartlink."
				...
				+ "for Audio External link through Edit smartlink"				
				+"ALFDEPLOY-4130_Verify Select File Button is displayed under Audio External link to choose existing "
				+ "files from alfresco in Edit smartlink Screen."
				+"ALFDEPLOY-4129_Verify Select File Button is displayed under Audio External link to choose from"
				+ " existing files in Create smartlink Screen."
				+"ALFDEPLOY-4224_Verify on click of Edit smartlink for Audio External object, the Edit smartlink form "
				+ "should be expanded."
				+"ALFDEPLOY-4131_Verify user is able to clear the uploaded file and its path under Audio External Link"
				+ " through Edit Smart Link option."
				+"ALFDEPLOY-4131_Verify user is able to clear the selected file and its path under Audio External Link"
				+ " through Edit Smart Link option."
				);
	...
	//	sitesPage.enterIntoDocumentLibrary();
		...
		//UIHelper.waitForPageToLoad(driver);
			...
			e.printStackTrace();
			report.updateTestLog("AUT_AG_024P3 status:", "<br>AUT_AG_024P3 Testcase is Failed", Status.FAIL);							
