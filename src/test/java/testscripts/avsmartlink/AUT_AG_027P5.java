...
public class AUT_AG_027P5 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		...
		"ALFDEPLOY-4118_Verify the Minor version increment on editing any fields available for pdf "
		+ "links via Edit smart link screen"
		+"ALFDEPLOY-4118_Verify the version should not get incremented for pdf links "
		+ "when saving the details via Edit smart link screen without editing any field values."
		+"ALFDEPLOY-4223_Verify title and url of pdf smart link object is editable and there "
