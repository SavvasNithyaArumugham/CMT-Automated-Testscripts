...
public class AUT_AG_025P7 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		testParameters.setCurrentTestDescription(
				...
				" <br>ALFDEPLOY-4127_To verify Edit smartlink  option is getting display for smartlink- EXTERNAL WEBSITE"			
				+"<br>ALFDEPLOY-4127_To verify Edit smartlink  option is not getting display for files other than "
				+ "smartlink file."
				+"<br>ALFDEPLOY-4127_To verify user is able to submit successfully after making changes in smartlink "
				+ "properties and the version of the smartlink changes after every edit in Edit of smartlink-EXTERNAL WEBSITE."
				+"<br>ALFDEPLOY-4127_To verify on clicking Cancel button , changes made by the user will revert back to "
				+ "original state in Edit smartlink-EXTERNAL WEBSITE file."
				+"ALFDEPLOY-4116_To verify user is not getting Edit Smartlink option via More for contents other "
				+ "than smart link object types."
				+"ALFDEPLOY-4116_To verify user is getting edit Smartlink option via More for External Website type smart link object."
				+"ALFDEPLOY-4117_To verify for External Web site smart link object on clicking Edit Smart link via More option ,"
				+ " user is getting only External Web site form pop up displaying existing field values."
				);
	...
	public void executeTest() {
		...
		if(flag1){
			...
			report.updateTestLog("AUT_AG_025P7 status:", "<br>AUT_AG_025P7 Testcase is Failed", Status.FAIL);							
