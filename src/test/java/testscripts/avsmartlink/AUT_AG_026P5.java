...
public class AUT_AG_026P5 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		testParameters.setCurrentTestDescription(
			...
			+ "file through Edit Smart Link screen under Image Preview in Audio External Link."
			+"ALFDEPLOY-4135_Verify the validation message is displayed on selecting a unsupported file through Edit "
			+ "Smart Link screen under Image Preview in Audio External Link"
			+"ALFDEPLOY-4135_Verify the version of Smart Link changes for Audio External link after Image preview "
			+ "upload file field is updated with new image and submitted successfully."
			+"ALFDEPLOY-4135_Verify the version of Smart Link changes for Audio External link when already uploaded "
			+ "image in Image preview upload file field is cleared and submitted successfully."
			+"ALFDEPLOY-4135_Verify the version of Smart Link changes for Audio External link after Image preview select "
			+ "file field is updated with new image and submitted successfully."
			+"ALFDEPLOY-4135_Verify the version of Smart Link changes for Audio External link when already selected "
			...
			+ "already added image via Edit smart link and on performing cancel action for Audio External link"
