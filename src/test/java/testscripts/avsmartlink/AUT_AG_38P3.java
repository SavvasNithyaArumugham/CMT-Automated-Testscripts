...
public class AUT_AG_38P3 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void AV_002() {
		testParameters.setCurrentTestDescription("1.ALFDEPLOY-3873_Verify the creation of 3rd party interactive link with 3PI vendor(Geogebra) and Optimized for use on mobile radio button options filled "
				);
