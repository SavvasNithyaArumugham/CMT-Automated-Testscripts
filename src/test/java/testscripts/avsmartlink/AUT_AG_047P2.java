...
public class AUT_AG_047P2 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				"ALFDEPLOY-4121_Verify Co-ordinator/Collaborator/Contributor is getting Edit smartlink option displayed for Edit 3rd party interactive smartlink file"+" which is created by manager and Co-ordinator/collaborator are able to edit"
						+"ALFDEPLOY-4221_To verify user (Manager/co-ordinator/collaborator/contributor) is getting Vendor list dropdown under 3rd party Interactive link"	
	...
	public void executeTest() {
		...
		try {
			...
			String tagname= driver.findElement(By.xpath(avsmart.thirdpartydropdownXpath)).getTagName();
			if(tagname.equalsIgnoreCase("Select")){
				report.updateTestLog("Verify 3PI Vendor is dropdown or not",
						"<br>3PI Vendor is dropdown", Status.PASS);
			}else{
				report.updateTestLog("Verify 3PI Vendor is dropdown or not",
						"<br>3PI Vendor is not dropdown", Status.FAIL);
			}
