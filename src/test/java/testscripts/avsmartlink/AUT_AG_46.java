...
public class AUT_AG_46 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void thirdPartyDigiCsvFieldCheck() {
		testParameters.setCurrentTestDescription(
				"1.ALFDEPLOY-5852_Verify 2 new fields Width and Height are added in 3rd Party Interactive multi smartlink csv template"
				+"<br>2.ALFDEPLOY-5852_Verify success message is displayed in 3rd party multi smart link csv template when numeric values are entered in Width and Height columns of csv template."
				+"<br>3.ALFDEPLOY-5852_Verify error message is displayed in 3rd party multi smart link csv template when decimal values are entered in Width and Height columns of csv template."	
				+"<br>4.AALFDEPLOY-5852_Verify error message is displayed in 3rd party multi smart link csv template when other than numeric values like characters and special characters are entered in Width and Height columns of csv template.");
