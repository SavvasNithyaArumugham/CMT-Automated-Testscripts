...
public class AUT_AG_025P8 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		testParameters.setCurrentTestDescription(
				...
				"1.Verify the version of Smart Link changes when all the fields of Table link is edited and submitted successfully"
				+"<br>2.Verify the version of Smart Link changes for Table link after Title field is edited and submitted successfully"
				+"<br>3.Verify the version of Smart Link changes for Table link after External URL Link field is edited and submitted successfully"
				+"<br>4.Verify the version of Smart Link changes for Table link after Image preview Upload file field is updated with new image and submitted successfully"
				+"<br>5.Verify the version of Smart Link changes for Table link when already uploaded image in Image preview Upload file field is cleared and submitted successfully"
				+"<br>6.Verify the version of Smart Link changes for Table link after Image preview select file field is updated with new image and submitted successfully"
				+"<br>7.Verify the version of Smart Link changes for Table link when already selected image in Image preview select file field is cleared and submitted successfully"
				+"<br>8.Verify the version of Smart Link changes for Table link after Image Reference URL field is edited and submitted successfully"
				+"<br>9.Verify the version of Smart Link changes for Table link after Image Alt text field is edited and submitted successfully"
				+"<br>10.Verify the version of Smart Link changes for Table link after Caption Text field is edited and submitted successfully"
				+"<br>11.Verify the version of Smart Link changes for Table link after Copyright or Credit Text field is edited and submitted successfully"
				+"<br>12.Verify on click of Cancel button user is able to cancel the changes and is able to revert back to original smartlink state in Edit smart link - Table form ."			
				+"<br>13.verify user is getting edit Smartlink option via More for table type smart link object."			
				+"<br>14.verify for Table smart link object on clicking Edit Smart link via More option,user is getting only table form pop up displaying exsisting field values."
	...
	//	UIHelper.waitForPageToLoad(driver);
		...
		if(flag1){
			...
			report.updateTestLog("AUT_AG_025P8 status:", "<br>AUT_AG_025P8 Testcase is Failed", Status.FAIL);							
