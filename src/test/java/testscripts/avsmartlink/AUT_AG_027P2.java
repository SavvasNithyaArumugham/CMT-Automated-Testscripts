...
public class AUT_AG_027P2 extends TestCase {
	...
	public void AVSMARTLINK_025() {
		...
		"ALFDEPLOY-4118_Verify the Minor version increment on editing any fields available for 3rd "
		+ "party interactive links via Edit smart link screen"
		+"ALFDEPLOY-4118_Verify the version should not get incremented for 3rd party interactive links "
		+ "when saving the details via Edit smart link screen without editing any field values."
		+"ALFDEPLOY-4223_Verify title and url of 3rd party interactive smart link object is editable and there "
	...
	public void executeTest() {
		...
		avsmart.VersionCheckdocument("1.1", "Changed");
			...
			report.updateTestLog("AUT_AG_027P2 status:", "<br>AUT_AG_027P2 Testcase is Failed", Status.FAIL);							
