...
public class AUT_AG_024P5 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				"<br>ALFDEPLOY-4134_Verify the UI path for an already uploaded image under Image Preview - Upload file "
						+ "button for 3rd Party Interactive link through Edit smartlink."
						+ "<br>ALFDEPLOY-4134_Verify the UI path on uploading a new file under Image Preview - Upload file button "
						+ "for 3rd Party Interactive link through Edit smartlink."
						...
						+ "for 3rd Party Interactive link through Edit smartlink"
						+ "ALFDEPLOY-4130_Verify Select File Button is displayed under 3rd Party Interactive link to choose "
						+ "existing files from alfresco in Edit smartlink Screen."
						+ "ALFDEPLOY-4129_Verify Select File Button is displayed under 3rd Party Interactive link to choose "
						+ "from existing files in Create smartlink Screen."
						+ "ALFDEPLOY-4224_Verify on click of Edit smartlink for 3rd Party Interactive object, the Edit smartlink "
						+ "form should be expanded."
						+ "ALFDEPLOY-4131_Verify user is able to clear the uploaded file and its path under 3rd Party Interactive Link "
						+ "through Edit Smart Link option."
						+ "ALFDEPLOY-4131_Verify user is able to clear the selected file and its path under 3rd Party Interactive Link through"
						+ " Edit Smart Link option.<br>"
						+ "R2.0.2_ALFDEPLOY-6248_Verify if Optimized for use on Mobile radio button in UI is default to Yes in 3rd Party Interactive Smartlink<br>"
						+ "R2.0.2_ALFDEPLOY-5241_Verify non admin users but not a part of large site is able to load the document library page without any slowness.<br>"
						+ "R2.0.2_[1]ALFDEPLOY-5241_Verify user is able to navigate to folders in document library without any slowness"
	...
	public void executeTest() {
		...
		try {
			...
			for (String link : smartlinktype) {
				...
				avsmart.entersmarttypedata(link, title, extURLLink, "Image", "Caption", "credit", "",
						System.getProperty("user.dir") + filePath + fileName);
				// to check default selection of optimized radio button
				...
				// avsmart.entersmarttypedata(link, "", "", "", "", "","",
				// System.getProperty("user.dir")+filePath+fileName);
				// avsmart.entersmarttypedata(link, title, extURLLink, "Image",
				// "Caption", "credit", "",System.getProperty("user.dir") +
				// filePath + fileName);
				...
				// Verify user is able to navigate to folders in document
				// library without any slowness
				sitesPage.enterIntoDocumentLibrary();
				docLibPg.isFileIsAvailable(title);
