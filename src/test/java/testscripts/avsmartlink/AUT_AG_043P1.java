...
public class AUT_AG_043P1 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				...
				"Verify Co-ordinator/Collaborator/Contributor is getting Edit smartlink  option displayed for Image external smartlink object which is created by manager and manager is able to edit"
