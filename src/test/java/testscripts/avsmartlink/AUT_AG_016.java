...
public class AUT_AG_016 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				"1.Verify new smart links are created in folders based on the spreadsheet values on selecting 'Create Multi Smart Link' option for the valid sl_video.csv file<br>"
				+"2. Validate the smart link is updated correctly when Title,external URL,JSON string fields are edited via edit properties for video link.");
