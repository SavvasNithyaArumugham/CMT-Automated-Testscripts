...
public class AUT_AG_009 extends TestCase {
	...
	public void AVSMARTLINK_008() {
		testParameters.setCurrentTestDescription(
				"1.Verify on applying Multi Smartlink , multiple content objects are generated successfully when uploading excel spreadsheet template with same type of external URL Links "
				+ "and 'Status' field in downloaded csv file from alfresco is updated with 'Success' message .<br>"
