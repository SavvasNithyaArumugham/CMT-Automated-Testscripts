...
public class AUT_BP_RevisedFileAndFolder extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void executeTest()
	{
		...
		doclib.commonMethodForClickOnMoreSettingsOption(fileName, "Upload New Version");
		doclib.uploadNewVersionInDocLibPage(fileName, filePath,"Minor","minor change");
		doclib.uploadNewVersionButton();
		UIHelper.waitFor(driver);
		myFiles.commonMethodForSelectingFiles(folderNames.get(0));
