...
public class AUT_BP_PubAndUnPubFolder extends TestCase
{
private FunctionalLibrary functionalLibrary;
	...
	public void executeTest()
	{
		...
		String folders = dataTable.getData("MyFiles", "Version");
		...
		myFiles.methodToSelectMultipleFiles(folders);
		...
		if (folders.contains(",")) {
			String splittedFileNames[] = folders.split(",");
			for (String fileNameVal : splittedFileNames) {
				docLibPgTest.verifyFolderPublished(fileNameVal);
			}
		} else {
			docLibPgTest.verifyFolderPublished(folders);
		}
