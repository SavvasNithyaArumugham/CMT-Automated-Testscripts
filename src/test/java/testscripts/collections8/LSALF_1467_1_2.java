...
public class LSALF_1467_1_2 extends TestCase {
	...
	public void COLLECTIONS_01_02() {
		testParameters
				.setCurrentTestDescription("Confirm successfull Import of test data set."
						+ "Confirm \"Comprehension Skills\" property is available and populated with CSV values");
		...
		sitesPage.createSite(siteNameValue, "Yes");
				...
				if (downloadedFile.exists() && !filename2.equalsIgnoreCase("File Not Found")) {
					...
					for (String csvRow : csvFileRowDataList) {
						...
						if (listOfObjectsString.contains(splitedRow[75].replace("\"", ""))) {
