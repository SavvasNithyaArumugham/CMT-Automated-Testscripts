 ...
 * @author Subhashini G
 */
public class LSALF_1859_3 extends TestCase {
	private FunctionalLibrary functionalLibrary;

	@Test
	public void LSALF_1859_31() {
	...
	public void executeTest() {
		...
		//Move the completed folder
			...
			UIHelper.waitFor(driver);
			collectionPg.commonMethodForClickOnMoreSettingsOption("Completed","Move to...");
			
			UIHelper.waitFor(driver);
			UIHelper.click(driver, "//*[contains(text(),'Learning Bundles')]");//Move To Learning Bundles Folder
			UIHelper.waitFor(driver);
			UIHelper.click(driver, "//*[@id=\"template_x002e_documentlist_v2_x002e_documentlibrary_x0023_default-copyMoveTo-ok-button\"]");//Click the Move Button
			UIHelper.waitFor(driver);
