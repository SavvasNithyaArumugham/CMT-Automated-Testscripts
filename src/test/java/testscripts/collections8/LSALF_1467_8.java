...
public class LSALF_1467_8 extends TestCase {
	...
	public void executeTest() {
		...
		sitesPage.createSite(siteNameValue, "Yes");
				...
				if (downloadedFile.exists() && !filename2.equalsIgnoreCase("File Not Found")) {
					...
					/***************************Confirm Comp Skills Leveled Reader properties are exporting properly*********************/
					String downloadedCSVFileANmeWithPath = downloadFilePath + "/" + filename2;
					
					
/************************************Modify Comp Skills in CSV and update***********************************/			
					...
					report.updateTestLog("Verify Comp Skills value is updated", "File: " + filename2
