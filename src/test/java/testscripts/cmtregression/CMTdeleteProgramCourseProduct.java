...
public class CMTdeleteProgramCourseProduct extends TestCase {
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"Click on delete 'X' option available before each Program, Course and Product");
	...
	public void executeTest() {
		...
		try {
			...
			//Delete Product
			managePage.deleteProduct();
			
			// Delete Course
			managePage.deleteCourse(course);
			UIHelper.waitFor(driver);
		/*	//Add program
			managePage.deleteProgram(program);
			UIHelper.waitFor(driver);
			*/
