...
public class CMTmanageProduct extends TestCase {
	...
	public void CMTHome71() {
		...
		"Verify user is able to create new Program,Course and Product");
	...
	public void executeTest() {
		...
		try {
			...
			//Add program
			managePage.addProgram(program);
			UIHelper.waitFor(driver);
			// Add Course
			managePage.addCourse(course);
			UIHelper.waitFor(driver);
			//Add Product
			managePage.addProduct(product,country,state);
			UIHelper.waitFor(driver);
			UIHelper.waitFor(driver);
			UIHelper.waitFor(driver);
