...
public class CMTcorrelationReportRerun extends TestCase 
{
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"Ensure the rerun button is enabled in the Correlation report");
	...
	public void executeTest() {
		...
		//Scroll to the rerun button
			...
			{
			report.updateTestLog("Correlation report generation-Rerun", "Correlation report generation-Rerun was successful" + "||" +successMessage, Status.PASS);
			}
			else
			{
			report.updateTestLog("Correlation report generation-Rerun", "Correlation report generation-Rerun was not successful", Status.FAIL);
			}
