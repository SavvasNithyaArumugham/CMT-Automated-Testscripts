...
public class CMTcurriculumDropDown extends TestCase {
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"Ensure the dropdowns are listed under Curriculum\r\n" + 
				"Ensure the new upload curriculum is displayed");
		...
		try {
		  ...
		  java.util.List<WebElement> options = selectBox.getOptions(); 
	        for(WebElement item:options) 
	        {
	     	...
	     	report.updateTestLog("CMT Manage Tab Curriculums ", "Drop Down Oprions in Curriculums are :"+dropDown, Status.PASS); 
