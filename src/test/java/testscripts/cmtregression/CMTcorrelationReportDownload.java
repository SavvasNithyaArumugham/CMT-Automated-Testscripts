...
public class CMTcorrelationReportDownload extends TestCase 
{
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"User is able to download Forward correlation report in the showlist");
	...
	public void executeTest() {
		...
		// Click on Rerun button
			...
			{
				report.updateTestLog("Verify download file", "Correlation report:File: " + fileName
