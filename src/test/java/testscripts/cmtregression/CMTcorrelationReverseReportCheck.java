...
public class CMTcorrelationReverseReportCheck extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void CMTHome71() {
		testParameters.setCurrentTestDescription("Ensure correlation Reverse report(Product-to-standard) is generated");
	...
	public void executeTest() {
		...
		report.updateTestLog("Correlations Reverse Reporting(Product-to-standard) ", "Correlations Reverse Report(Product-to-standard) generated", Status.PASS);
								
			} 
			else
			{
		report.updateTestLog("Correlation Reverse report(Product-to-standard)", "Correlation Reverse report(Product-to-standard) generation not successful", Status.FAIL);
			}
