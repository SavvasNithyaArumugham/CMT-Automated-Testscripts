...
public class CMTcopyAlignments extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void CMTHome71() {
		testParameters.setCurrentTestDescription("User should be able to copy alignments from one Curriculum Standard or TOC node and paste them to another node");
	...
	public void executeTest() {
		...
		try {
			...
			managePage.copyAlignmentsValidation();
