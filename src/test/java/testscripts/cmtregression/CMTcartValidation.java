...
public class CMTcartValidation extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void CMTHome71() {
		testParameters.setCurrentTestDescription("Cart validation-Align statements should be displayed");
	...
	public void executeTest() {
		...
		try {
			...
			managePage.clickAlignAndCartValidation();
