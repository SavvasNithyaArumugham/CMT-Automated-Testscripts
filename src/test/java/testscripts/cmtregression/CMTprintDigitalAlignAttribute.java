...
public class CMTprintDigitalAlignAttribute extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void CMTHome71() {
		testParameters.setCurrentTestDescription("Validate the Print and digital Alignment Attribute functionlities");
	...
	public void executeTest() {
		...
		try {
			...
			managePage.printDigitalAttribute();
