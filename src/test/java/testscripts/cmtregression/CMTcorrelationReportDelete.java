...
public class CMTcorrelationReportDelete extends TestCase 
{
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"User is able to delete Forward correlation report in the showlist");
	...
	public void executeTest() {
		...
		// Click on Rerun button
			...
			{
			report.updateTestLog("Correlation report generation delete", "Correlation report delete was successful" + "||" +successMessage, Status.PASS);
			}
			else
			{
			report.updateTestLog("Correlation report generation delete ", "Correlation report delete was not successful", Status.FAIL);
			}
