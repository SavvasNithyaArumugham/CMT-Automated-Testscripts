...
public class LSALF_2123_3SeqUpd extends TestCase {
	...
	public void COLLECTIONS_08() {
		testParameters
		.setCurrentTestDescription("Confirm Library values separated by pipe symbol in CSV update");
	...
	public void executeTest() {
		...
		// Log in Pearson Schools project
				...
				sitesPage.openSiteFromRecentSites( siteNameValue);
						...
						String pipesLibValue = dataTable.getData("MyFiles", "BrowseActionName");
				...
				if (downloadedFile.exists() && !filename2.equalsIgnoreCase("File Not Found")) {
					...
					try {
						CSVUtil.updateCSV(downloadedCSVFileANmeWithPath, pipesLibValue ,3 ,98 );
					} catch (IOException e) {
				 ...
				 // Go to Courses and navigate to Content Type
					...
					UIHelper.waitFor(driver);
					collectionPg.VerifyPropertyValueINviewDetails("Library:", "Core Texts|Hook and Inspire Texts");	
					UIHelper.waitFor(driver);
