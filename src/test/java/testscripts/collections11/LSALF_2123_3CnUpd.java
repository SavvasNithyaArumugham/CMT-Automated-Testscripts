...
public class LSALF_2123_3CnUpd extends TestCase {
	...
	public void executeTest() {
		...
		// Log in Pearson Schools project
				...
				if (downloadedFile.exists() && !filename2.equalsIgnoreCase("File Not Found")) {
					...
					try {
						CSVUtil.updateCSV(downloadedCSVFileANmeWithPath, pipesLibValue ,4 ,98 );
					} catch (IOException e) {
				 ...
				 // Go to Courses and navigate to Content Type
					...
					UIHelper.waitFor(driver);
					collectionPg.VerifyPropertyValueINviewDetails("Library:", "Core Texts");	
					UIHelper.waitFor(driver);
