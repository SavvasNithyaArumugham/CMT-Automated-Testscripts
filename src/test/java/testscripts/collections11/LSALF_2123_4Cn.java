...
public class LSALF_2123_4Cn extends TestCase {
	...
	public void executeTest() {
		...
		UIHelper.waitFor(driver);
		collectionPg.clickOnMouseOverMenu("AutoContainer","Edit Properties");
		UIHelper.waitFor(driver);
		...
		/*libraryValues.selectByIndex(2);
		libraryValues.selectByIndex(3);*/
