...
public class CMTManageCreateNewCurriculum1 extends TestCase {
	...
	public void CMTHome71() {
		testParameters.setCurrentTestDescription(
				"Check If Authority is created, its assosiated curriculum set is created. Check if Create new Curriculum is working with the new authority created.In the curriculum add the local grade and topic.");
