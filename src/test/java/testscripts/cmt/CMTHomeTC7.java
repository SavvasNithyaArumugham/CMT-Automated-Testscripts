...
public class CMTHomeTC7 extends TestCase {

	private FunctionalLibrary functionalLibrary;

	@Test
	public void CMTHome71() {
		testParameters.setCurrentTestDescription("Ensure that curriculums of selected country is displayed with view button on new page");
