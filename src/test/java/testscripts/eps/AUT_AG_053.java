...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_051()
	{
		testParameters.setCurrentTestDescription(
				...
				"[1]ALFDEPLOY-3910_Verify user able to download a sco zip file in local "
				+ "system by altering a publication url"
				+"[1]ALFDEPLOY-3910_Verify user able to publish a  sco zip file"
	...
	public void executeTest()
	{
		...
		//Value Declaration
			...
			e.printStackTrace();
			report.updateTestLog("EPS_53 Status", "EPS 53 Testcases has been failed", Status.FAIL);	
			}
}
