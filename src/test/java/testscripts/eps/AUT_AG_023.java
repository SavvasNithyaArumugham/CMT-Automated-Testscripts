...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_021()
	{
		testParameters.setCurrentTestDescription("1) ALFDEPLOY-3784_01_Verify that Alfresco is storing user information While trying to republish the folder which caontains zip file in it for EPS folder type.<br>"
				  + "2) ALFDEPLOY-3784_01_Verify that Alfresco is storing user information While trying to republish SCO zip file for EPS Site type after uploading a minor new version.");	
