...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_021()
	{
		testParameters.setCurrentTestDescription("1) ALFDEPLOY-3779_Verify there will be only one URL if there will be content already published as folder for EPS site type site.<br>");	
