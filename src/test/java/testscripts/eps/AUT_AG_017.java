...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_008()
	{
		testParameters.setCurrentTestDescription("Verify the 'Published URL' and 'SCO player URL' values displayed with valid URL value for a ZIP files Prior to publishing.");
