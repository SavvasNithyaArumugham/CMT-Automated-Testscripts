...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_021()
	{
		testParameters.setCurrentTestDescription("1) ALFDEPLOY-3784_01_Verify that Alfresco is storing user information While trying to republish SCO zip file for EPS folder type after uploading a minor new version.<br>"
										  + "2) ALFDEPLOY-3784_01_Verify that Alfresco is storing user information While trying to republish SCO zip file for EPS folder type after uploading a major new version."
				+"ALFDEPLOY-3784_Verify that Alfresco is storing user information While trying to republish SCO zip file for EPS folder type after reverting to old version.");
