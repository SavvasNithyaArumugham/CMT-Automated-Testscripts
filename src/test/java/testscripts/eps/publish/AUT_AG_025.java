...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_011()
	{
		testParameters.setCurrentTestDescription("Publish - zip file inside SCO folder - expanded mode (without checking the checkbox");
	...
	//Publish zip file within the sco level folder
				...
				//Check EPS ID for zip file inside SCO folder - expanded mode
