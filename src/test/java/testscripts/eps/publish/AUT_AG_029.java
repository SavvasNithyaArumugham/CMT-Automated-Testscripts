...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_011()
	{
		testParameters.setCurrentTestDescription("Publish - SCO zip file in expanded mode via folder level publish");
	...
	public void executeTest()
	{
		...
		//Publish zip file in expanded mode via folder level publish
		sitesPage.enterIntoDocumentLibrary();
		...
		epsPg.publishbutton(folderName, moreSettingsOptionName);
				...
				//Check EPS ID for SCO zip file in expanded mode via folder level publish
