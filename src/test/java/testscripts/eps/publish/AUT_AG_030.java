...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_011()
	{
		testParameters.setCurrentTestDescription("Publish - SCO zip file in expanded mode which does not contain player.html file");
	...
	public void executeTest()
	{
		...
		//Create sco a folder and Upload a zip file 
		myFiles.createFolder(folderDetails);
		myFiles.openCreatedFolder(folderName);										
		myFiles.uploadFile(filePath, fileName);
		
		//Publish zip file in epanded mode via folder level publish
		sitesPage.enterIntoDocumentLibrary();
		sitesPage.clickOnMoreSetting(folderName);	
		epsPg.publishbutton(folderName, moreSettingsOptionName);
				
				String zipUploadXpath =".//*[@id='zipUpload']";
				UIHelper.click(driver, zipUploadXpath);
				UIHelper.waitFor(driver);
				...
				//Check EPS ID for SCO zip file in expanded mode which does not contain player.html file
