...
private FunctionalLibrary functionalLibrary;
	...
	public void EPS_003()
	{
		testParameters.setCurrentTestDescription("1) Verify the new 'Published URL' read-only text field added to the edit properties window for published files."
										  + "</br>2) Verify the new 'Published URL' read-only text field is not added to the edit properties window for published folders.");
