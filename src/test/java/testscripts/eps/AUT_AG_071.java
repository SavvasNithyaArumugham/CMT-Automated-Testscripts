...
public class AUT_AG_071 extends TestCase {
	...
	public void EPS_001() {
		testParameters.setCurrentTestDescription(
				"R2.0.2_ALFDEPLOY-5696_Verify optimized file is auto created and auto published in Optimized folder upon promoting the lifecycle state of an image to Optimize for PNG from Ready for Optimization via More or preview page"
						+ "<br>R2.0.2_ALFDEPLOY-5696_Verify optimized file is auto-created and auto published in Optimized folder upon Promoting the lifecycle state to Optimize for JPG from Optimization completed via More or preview page for PNG optimization completed file"
