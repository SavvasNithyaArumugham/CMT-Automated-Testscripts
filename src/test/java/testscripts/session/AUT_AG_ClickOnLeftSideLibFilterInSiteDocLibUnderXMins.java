 ...
 */
public class AUT_AG_ClickOnLeftSideLibFilterInSiteDocLibUnderXMins extends TestCase {
	...
	public void executeTest() {
		...
		docLibPg.clickOnDocOrLibraryFilterItem("Library", labelName, minutes,"Negative");
	}
