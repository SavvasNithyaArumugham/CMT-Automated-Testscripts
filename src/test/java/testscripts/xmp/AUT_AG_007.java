...
public class AUT_AG_007 extends TestCase {
    ...
    @Test
    public void xmp_07() {
        testParameters.setCurrentTestDescription("1. Verify if the XMP metadata Properties are visible in a newly imported JPG file"
        		+ "<br>2. Verify if the user  is able to edit/update the metadata Properties in a JPG file.");
