...
public class AUT_AG_019 extends TestCase
{
	...
	@Test
	public void runAUT_AG_019()
	{
		testParameters.setCurrentTestDescription("Verify the edit function for Tag inside alfresco after uploading JPEG file with XMP Keyword property.");
	...
	public void executeTest()
	{
		...
		docPrevPage.editTag(tagName, editTagName);
		
		if(docPrevPage.isTagCreated(fileName, tagName, false)){
			report.updateTestLog("Verify the Edited Tag Hyperlink details",
					"Verified successfully", Status.PASS);
		}else{
			report.updateTestLog("Verify the Edited Tag Hyperlink details",
					"Hyperlink not available", Status.FAIL);
