...
public class AUT_AG_005 extends TestCase {
    ...
    @Test
    public void xmp_05() {
        testParameters.setCurrentTestDescription("1. Verify if the XMP metadata Properties are visible in a newly imported PSD file."
        		+ "<br>2. Verify if the user is able to edit/update the metadata Properties in a PSD file.");
